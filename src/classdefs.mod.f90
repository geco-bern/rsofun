...
!--------------------------ORGANIC---------------------------------
  ...
  ! function orgmult( pool1, pool2 ) result( out_orgmult )
  !   !////////////////////////////////////////////////////////////////
  !   !  Generic function to return variable product of two pools of 
  !   !  type 'orgpool'. Sum is of type 'orgpool' as well.
  !   !----------------------------------------------------------------
  ...
  !   ! function return variable
  !   type(orgpool) :: out_orgmult

  !   out_orgmult%c = cmult( pool1%c, pool2%c )
  !   out_orgmult%n = nmult( pool1%n, pool2%n )

  ! end function orgmult


  ! function cmult( pool1, pool2 ) result( out_cmult )
  !   !////////////////////////////////////////////////////////////////
  !   !  Generic function to return variable product of two pools of 
  !   !  type 'carbon'. Sum is of type 'carbon' as well.
  !   !----------------------------------------------------------------
  ...
  !   ! function return variable
  !   type(carbon) :: out_cmult

  !   out_cmult%c12 = pool1%c12 * pool2%c12

  ! end function cmult


  ! function nmult( pool1, pool2 ) result( out_nmult )
  !   !////////////////////////////////////////////////////////////////
  !   !  Generic function to return variable product of two pools of 
  !   !  type 'carbon'. Sum is of type 'carbon' as well.
  !   !----------------------------------------------------------------
  ...
  !   ! function return variable
  !   type(nitrogen) :: out_nmult

  !   out_nmult%n14 = pool1%n14 * pool2%n14
