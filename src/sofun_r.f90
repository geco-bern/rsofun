...
contains
  ...
  subroutine pmodel_f(         &
    ...
    ! xxx debug
    print*,'======================================'
    print*,'kphio                :', myinterface%params_calib%kphio, real(par(1))
    print*,'soilm_par_a          :', myinterface%params_calib%soilm_par_a, real(par(2))
    print*,'soilm_par_b          :', myinterface%params_calib%soilm_par_b, real(par(3))
    print*,'tau_acclim_tempstress:', myinterface%params_calib%tau_acclim_tempstress, real(par(4))
    print*,'par_shape_tempstress :', myinterface%params_calib%par_shape_tempstress, real(par(5))
    print*,'f_nretain            :', myinterface%params_calib%f_nretain, real(par(6))
    print*,'fpc_tree_max         :', myinterface%params_calib%fpc_tree_max, real(par(7))
    print*,'growtheff            :', myinterface%params_calib%growtheff, real(par(8))
    print*,'r_root               :', myinterface%params_calib%r_root, real(par(9))
    print*,'r_sapw               :', myinterface%params_calib%r_sapw, real(par(10))
    print*,'exurate              :', myinterface%params_calib%exurate, real(par(11))
    print*,'cton_soil            :', myinterface%params_calib%cton_soil, real(par(12))
    print*,'k_decay_leaf_base    :', myinterface%params_calib%k_decay_leaf_base, real(par(13))
    print*,'k_decay_leaf_width   :', myinterface%params_calib%k_decay_leaf_width, real(par(14))
    print*,'k_decay_root         :', myinterface%params_calib%k_decay_root, real(par(15))
    print*,'k_decay_labl         :', myinterface%params_calib%k_decay_labl, real(par(16))
    print*,'k_decay_sapw         :', myinterface%params_calib%k_decay_sapw, real(par(17))
    print*,'r_cton_root          :', myinterface%params_calib%r_cton_root, real(par(18))
    print*,'r_cton_wood          :', myinterface%params_calib%r_cton_wood, real(par(19))
    print*,'ncw_min              :', myinterface%params_calib%ncw_min, real(par(20))
    print*,'r_n_cw_v             :', myinterface%params_calib%r_n_cw_v, real(par(21))
    print*,'r_ctostructn_leaf    :', myinterface%params_calib%r_ctostructn_leaf, real(par(22))
    print*,'kbeer                :', myinterface%params_calib%kbeer, real(par(23))
    print*,'gddbase              :', myinterface%params_calib%gddbase, real(par(24))
    print*,'ramp                 :', myinterface%params_calib%ramp, real(par(25))
    print*,'phentype             :', myinterface%params_calib%phentype, real(par(26))
    print*,'perc_k1              :', myinterface%params_calib%perc_k1, real(par(27))
    print*,'thdiff_wp            :', myinterface%params_calib%thdiff_wp, real(par(28))
    print*,'thdiff_whc15         :', myinterface%params_calib%thdiff_whc15, real(par(29))
    print*,'thdiff_fc            :', myinterface%params_calib%thdiff_fc, real(par(30))
    print*,'forg                 :', myinterface%params_calib%forg, real(par(31))
    print*,'wbwp                 :', myinterface%params_calib%wbwp, real(par(32))
    print*,'por                  :', myinterface%params_calib%por, real(par(33))
    print*,'fsand                :', myinterface%params_calib%fsand, real(par(34))
    print*,'fclay                :', myinterface%params_calib%fclay, real(par(35))
    print*,'fsilt                :', myinterface%params_calib%fsilt, real(par(36))
    print*,'kA                   :', myinterface%params_calib%kA, real(par(37))
    print*,'kalb_sw              :', myinterface%params_calib%kalb_sw, real(par(38))
    print*,'kalb_vis             :', myinterface%params_calib%kalb_vis, real(par(39))
    print*,'kb                   :', myinterface%params_calib%kb, real(par(40))
    print*,'kc                   :', myinterface%params_calib%kc, real(par(41))
    print*,'kCw                  :', myinterface%params_calib%kCw, real(par(42))
    print*,'kd                   :', myinterface%params_calib%kd, real(par(43))
    print*,'ke                   :', myinterface%params_calib%ke, real(par(44))
    print*,'keps                 :', myinterface%params_calib%keps, real(par(45))
    print*,'kWm                  :', myinterface%params_calib%kWm, real(par(46))
    print*,'kw                   :', myinterface%params_calib%kw, real(par(47))
    print*,'komega               :', myinterface%params_calib%komega, real(par(48))
    print*,'maxmeltrate          :', myinterface%params_calib%maxmeltrate, real(par(49))
    print*,'klitt_af10           :', myinterface%params_calib%klitt_af10, real(par(50))
    print*,'klitt_as10           :', myinterface%params_calib%klitt_as10, real(par(51))
    print*,'klitt_bg10           :', myinterface%params_calib%klitt_bg10, real(par(52))
    print*,'kexu10               :', myinterface%params_calib%kexu10, real(par(53))
    print*,'ksoil_fs10           :', myinterface%params_calib%ksoil_fs10, real(par(54))
    print*,'ksoil_sl10           :', myinterface%params_calib%ksoil_sl10, real(par(55))
    print*,'ntoc_crit1           :', myinterface%params_calib%ntoc_crit1, real(par(56))
    print*,'ntoc_crit2           :', myinterface%params_calib%ntoc_crit2, real(par(57))
    print*,'cton_microb          :', myinterface%params_calib%cton_microb, real(par(58))
    print*,'tmppar               :', myinterface%params_calib%tmppar, real(par(59)) ! used for development
    print*,'fastfrac             :', myinterface%params_calib%fastfrac, real(par(60))
    print*,'eff_nup              :', myinterface%params_calib%eff_nup, real(par(61))
    print*,'minimumcostfix       :', myinterface%params_calib%minimumcostfix, real(par(62))
    print*,'fixoptimum           :', myinterface%params_calib%fixoptimum, real(par(63))
    print*,'a_param_fix          :', myinterface%params_calib%a_param_fix, real(par(64))
    print*,'b_param_fix          :', myinterface%params_calib%b_param_fix, real(par(65))
    print*,'maxnitr              :', myinterface%params_calib%maxnitr, real(par(66))
    print*,'non                  :', myinterface%params_calib%non, real(par(67))
    print*,'n2on                 :', myinterface%params_calib%n2on, real(par(68))
    print*,'kn                   :', myinterface%params_calib%kn, real(par(69))
    print*,'kdoc                 :', myinterface%params_calib%kdoc, real(par(70))
    print*,'docmax               :', myinterface%params_calib%docmax, real(par(71))
    print*,'dnitr2n2o            :', myinterface%params_calib%dnitr2n2o, real(par(72))
    print*,'beta                 :', myinterface%params_calib%beta, real(par(73))
    print*,'rd_to_vcmax          :', myinterface%params_calib%rd_to_vcmax, real(par(74))
    print*,'tau_acclim           :', myinterface%params_calib%tau_acclim, real(par(75))
    print*,'======================================'
