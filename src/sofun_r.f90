...
contains
  ...
  subroutine populate_outarray_annual_tile( annual_tile, out_annual_tile )
    ...
    out_annual_tile(6)  = dble(annual_tile%NPP)
    out_annual_tile(7)  = dble(annual_tile%GPP)
    out_annual_tile(8)  = dble(annual_tile%Rauto)
    out_annual_tile(9)  = dble(annual_tile%Rh)
    out_annual_tile(10)  = dble(annual_tile%rain)
    out_annual_tile(11)  = dble(annual_tile%SoilWater)
    out_annual_tile(12)  = dble(annual_tile%Transp)
    out_annual_tile(13) = dble(annual_tile%Evap)
    out_annual_tile(14) = dble(annual_tile%Runoff)
    out_annual_tile(15) = dble(annual_tile%plantC)
    out_annual_tile(16) = dble(annual_tile%soilC)
    out_annual_tile(17) = dble(annual_tile%plantN)
    out_annual_tile(18) = dble(annual_tile%soilN)
    out_annual_tile(19) = dble(annual_tile%totN)
    out_annual_tile(20) = dble(annual_tile%NSC)
    out_annual_tile(21) = dble(annual_tile%SeedC)
    out_annual_tile(22) = dble(annual_tile%leafC)
    out_annual_tile(23) = dble(annual_tile%rootC)
    out_annual_tile(24) = dble(annual_tile%SapwoodC)
    out_annual_tile(25) = dble(annual_tile%WoodC)
    out_annual_tile(26) = dble(annual_tile%NSN)
    out_annual_tile(27) = dble(annual_tile%SeedN)
    out_annual_tile(28) = dble(annual_tile%leafN)
    out_annual_tile(29) = dble(annual_tile%rootN)
    out_annual_tile(30) = dble(annual_tile%SapwoodN)
    out_annual_tile(31) = dble(annual_tile%WoodN)
    out_annual_tile(32) = dble(annual_tile%McrbC)
    out_annual_tile(33) = dble(annual_tile%fastSOM)
    out_annual_tile(34) = dble(annual_tile%SlowSOM)
    out_annual_tile(35) = dble(annual_tile%McrbN)
    out_annual_tile(36) = dble(annual_tile%fastSoilN)
    out_annual_tile(37) = dble(annual_tile%slowSoilN)
    out_annual_tile(38) = dble(annual_tile%mineralN)
    out_annual_tile(39) = dble(annual_tile%N_fxed)
    out_annual_tile(40) = dble(annual_tile%N_uptk)
    out_annual_tile(41) = dble(annual_tile%N_yrMin)
    out_annual_tile(42) = dble(annual_tile%N_P2S)
    out_annual_tile(43) = dble(annual_tile%N_loss)
    out_annual_tile(44) = dble(annual_tile%totseedC)
    out_annual_tile(45) = dble(annual_tile%totseedN)
    out_annual_tile(46) = dble(annual_tile%Seedling_C)
    out_annual_tile(47) = dble(annual_tile%Seedling_N)
