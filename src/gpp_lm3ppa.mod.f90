module md_gpp_lm3ppa
  ...
  type pftparamstype_gpp
    real :: kphio = 0.05 ! (Simulations: 0.05, 0.0575, 0.065) 0.24 hard-coded here, is a calibratable parameter in P-model, unrealistically high here to match ballpark of original model
