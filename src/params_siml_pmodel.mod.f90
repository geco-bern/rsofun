module md_params_siml_pmodel
  ...
  type paramstype_siml
    ...
    logical :: use_gs               ! Whether pmodel calculated gs should be used for transpiration calculations
    logical :: use_pml              ! Whether Penmann-Monteith-Leuning formulation should be used for ET 
