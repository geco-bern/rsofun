...
void F77_NAME(lm3ppa_f)(
    ...
    double *params_soil,                   
    double *params_calib_tile,                   
    double *params_calib_species,                   
    double *init_cohort,                   
...
extern SEXP lm3ppa_f_C(
    ...
    SEXP params_species,                   
    SEXP params_soil,                   
    SEXP params_calib_tile,                   
    SEXP params_calib_species,                   
    SEXP init_cohort,                   
    ...
    SEXP output_annual_tile            = PROTECT( allocMatrix(REALSXP, nt_annual, 57) );   // 2nd agument to allocMatrix is number of rows, 3rd is number of columns.  xxx todo
