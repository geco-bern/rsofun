...
Small dataset representing the driver to run the P-model at four
separate sites. It can also be used together with leaf traits data from
these four sites
([`p_model_validation_vcmax25`](https://geco-bern.github.io/rsofun/dev/reference/p_model_validation_vcmax25.md))
to optimize model parameters. To optimize model parameters to GPP flux
data use the datasets
...
C.D. Keeling, R.B. Bacastow, A.E. Bainbridge, C.A. Ekdahl, P.R.
Guenther, and L.S. Waterman, (1976), Atmospheric carbon dioxide
