---
title: "Benchmark rsofun tag v3.4.2"
output:
  html_document:
    toc: true
    toc_float: true
...
Change name after update implemented with v3.4.2.
```{r}
df_drivers_fluxnet2015 <- df_drivers_fluxnet2015 %>% 
...
save(df_output, file = "~/data/rsofun_benchmarking/out_eval_v3.4.2.Rdata")
```
...
save(df_output_allsites, file = "~/data/rsofun_benchmarking/df_output_allsites_v3.4.2.Rdata")
```
