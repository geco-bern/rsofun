---
title: "Benchmark rsofun tag v3.3"
output:
  html_document:
    toc: true
    toc_float: true
...
save(df_output, file = "~/data/rsofun_benchmarking/df_output_v3.3.Rdata")
```
...
save(df_output, file = "~/data/rsofun_benchmarking/out_eval_v3.3.Rdata")
```
...
save(df_output_allsites, file = "~/data/rsofun_benchmarking/df_output_allsites_v3.3.Rdata")
```
