...
#' there should only be one observed value per site (traits), and the outputs 
#' (averaged over the growing season) will be 
#' compared to this single value representative of the site (e.g. Vcmax25). As exception,
