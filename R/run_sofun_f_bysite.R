...
run_sofun_f_bysite <- function( sitename, params_siml, siteinfo, forcing, df_soiltexture, params_modl, makecheck = TRUE ){
  ...
  if (do_continue){
    ...
    out <- .Call(
      ...
      # daily_out_startyr         = as.integer(params_siml$daily_out_startyr),
      # daily_out_endyr           = as.integer(params_siml$daily_out_endyr),
      ...
      # loutplant                 = as.logical(params_siml$loutplant),
      # loutgpp                   = as.logical(params_siml$loutgpp),
      # loutwaterbal              = as.logical(params_siml$loutwaterbal),
      # loutforcing               = as.logical(params_siml$loutforcing),
      # loutdgpp                  = as.logical(params_siml$loutdgpp),
      # loutdrd                   = as.logical(params_siml$loutdrd),
      # loutdtransp               = as.logical(params_siml$loutdtransp),
      # loutdwcont                = as.logical(params_siml$loutdwcont),
      # loutdaet                  = as.logical(params_siml$loutdaet),
      # loutdpet                  = as.logical(params_siml$loutdpet),
      # loutdnetrad               = as.logical(params_siml$loutdnetrad),
      # loutdwbal                 = as.logical(params_siml$loutdwbal),
      # loutdtemp                 = as.logical(params_siml$loutdtemp),
      # loutdfapar                = as.logical(params_siml$loutdfapar),
      # loutdtemp_soil            = as.logical(params_siml$loutdtemp_soil),
      # lcalibgpp                 = as.logical(params_siml$lcalibgpp),
      # lcalibfapar               = as.logical(params_siml$lcalibfapar),
      # lcalibtransp              = as.logical(params_siml$lcalibtransp),
      # lcaliblatenth             = as.logical(params_siml$lcaliblatenth),
