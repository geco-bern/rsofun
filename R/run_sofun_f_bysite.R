...
#' @param build A character specifiying which SOFUN build to use. Defaults to \code{"pmodel"}. 
#' One of \code{c("pmodel", "lm3ppa")}
#'
...
#' @useDynLib rsofun
#'
run_sofun_f_bysite <- function( sitename, params_siml, siteinfo, forcing, df_soiltexture, params_modl, makecheck = TRUE, build = "pmodel" ){
  ...
  if (build=="pmodel"){
    if (makecheck){
      ...
      if (nrow(forcing) != params_siml$nyeartrend * 365){    # xxx todo: must be *48 for lm3ppa
