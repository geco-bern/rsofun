...
#' Run SOFUN
#'
#' Runs SOFUN without reading the output
#'
#' @param settings A named list containing the simulation settings (see vignette_rsofun.pdf for more information and examples).
#' @param setup A named list containing the model setup settings (see vignette_rsofun.pdf for more information and examples).
#'
#' @return Returns the standard output from the model run
#' @export
#'
#' @examples mod <- run_sofun( settings = settings_sims, setup = setup_sofun )
...
#' Read SOFUN output
#'
#' Reads SOFUN output after the model has been run and output files created
#'
#' @param settings A named list containing the simulation settings (see vignette_rsofun.pdf for more information and examples).
#' @param setup A named list containing the model setup settings (see vignette_rsofun.pdf for more information and examples).
#'
...
#' @export
#'
#' @examples mod <- read_sofun( settings = settings_sims, setup = setup_sofun )
#' 
...
read_ncout_sofun_daily <- function( expname, settings ){
  ...
  if ( settings$loutdnetrad) vars <- c( vars, "netrad" )
  ...
  if (file.exists(path)){
    ...
    time <- conv_noleap_to_ymd( time, origin="2001-01-01" )
