...
#' information file, or a dataframe containing the site meta info. Required
#' columns are:
#' \describe{
#' \item{\code{site_name}}{Name of the site, must be the first column of the file.}
...
#' corresponding to data abailability from site.}
#' }
#' @param params_siml A named list containing the simulation parameters
#'  for SOFUN.
#'
#' @return A dataframe (tibble) containing the site meta information, 
