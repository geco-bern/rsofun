...
```{r eval = TRUE}
# run the model
lm3ppa_gs_leuning_output_test <- runread_lm3ppa_f(
     lm3ppa_gs_leuning_drivers,
     makecheck = TRUE,
     parallel = FALSE
     )
...
lm3ppa_gs_leuning_output_test <- lm3ppa_gs_leuning_output_test$data[[1]]$output_annual_tile
```
...
ggplot() +
  geom_line(aes(x = year, y = GPP), data = lm3ppa_gs_leuning_output, size = 1.5) +
  geom_line(aes(x = year, y = GPP), data = lm3ppa_gs_leuning_output_test, color = "red") +
  theme_classic() + 
  labs(x = "Year", y = "GPP")

ggplot() +
  geom_line(aes(x = year, y = plantC), data = lm3ppa_gs_leuning_output, size = 1.5) +
  geom_line(aes(x = year, y = plantC), data = lm3ppa_gs_leuning_output_test, color = "red") +
  theme_classic() + 
...
```{r eval = TRUE}
# run the model
lm3ppa_p_model_output_test <- runread_lm3ppa_f(
     lm3ppa_p_model_drivers,
     makecheck = TRUE,
     parallel = FALSE
     )
...
lm3ppa_p_model_output_test <- lm3ppa_p_model_output_test$data[[1]]$output_annual_tile
```
...
ggplot() +
  geom_line(aes(x = year, y = GPP), data = lm3ppa_p_model_output, size = 1.5) +
  geom_line(aes(x = year, y = GPP), data = lm3ppa_p_model_output_test, color = "red") +
  theme_classic()+
  labs(x = "Year", y = "GPP")

ggplot() +
  geom_line(aes(x = year, y = plantC), data = lm3ppa_p_model_output, size = 1.5) +
  geom_line(aes(x = year, y = plantC), data = lm3ppa_p_model_output, color = "red") +
  theme_classic()+
  labs(x = "Year", y = "plantC")
```
