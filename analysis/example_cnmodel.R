...
pars <- list(
  ...
  kphio_par_b           = 1.0,
  dehardening_gdd_midpoint = 150.0,   # GDD midpoint of dehardening
  dehardening_gdd_slope    = 0.05,    # sigmoid slope (degree-day^-1)
  dehardening_gdd_base     = 5.0,     # GDD base temperature (deg C)
