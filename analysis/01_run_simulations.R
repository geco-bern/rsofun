...
#save(df_drivers, file = "~/rsofun/data/inputs/df_drivers_DBH_gs.RData")
#save(df_drivers, file = "~/rsofun/data/inputs/df_drivers_GR_gs.RData")
...
write.csv(df_output$data[[1]]$output_annual_tile,   "~/rsofun/data/outputs/preGRp2gs_output_annual_tile.csv")
write.csv(df_output$data[[1]]$output_annual_cohorts,"~/rsofun/data/outputs/preGRp2gs_output_annual_cohorts.csv")
