...
## ----------------------------------------------------------------------------------------------------------------------
p_model_drivers <- rsofun::p_model_drivers_formatPhydro # TODO: NOT YET UPDATED FOR PHYDRO (still add default phydro_* parameters)
# p_model_validation <- rsofun::p_model_validation_formatPhydro
