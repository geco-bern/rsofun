---
title: "Prepare drivers"
output: html_document
---

# For LM3-PPA run for a network site simulation 
...
save(forcingLAE, file = "~/rsofun/data/forcingLAE.RData")

```

Make it a mean seasonal cycle.
```{r}
...
save(forcingLAE, file = "~/rsofun/data/forcingLAE_meandoy.RData")
```
