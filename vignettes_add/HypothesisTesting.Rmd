...
ea1sb3ma_out_hourly_tile <- out$output_hourly_tile
ea1sb3ma_out_daily_tile <- out$output_daily_tile
ea1sb3ma_out_daily_cohorts <- out$output_daily_cohorts
ea1sb3ma_out_annual_tile <- out$output_annual_tile
ea1sb3ma_out_annual_cohorts <- out$output_annual_cohorts
...
```{r}
setwd("/Users/lmarques/rsofun/Simulations_pmodel")
write.csv(ea1sb3ma_out_hourly_tile, "ea1sb3ma_out_hourly_tile.csv")
write.csv(ea1sb3ma_out_daily_tile,"ea1scb3ma_out_daily_tile.csv")
write.csv(ea1sb3ma_out_daily_cohorts,"ea1sb3ma_out_daily_cohorts.csv")
write.csv(ea1sb3ma_out_annual_tile,"ea1sb3ma_out_annual_tile.csv")
write.csv(ea1sb3ma_out_annual_cohorts,"ea1sb3ma_out_annual_cohorts.csv")
```
...
ea1sa1ma_out_annual_cohorts <- ea1sa1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea1sa2ma_out_annual_cohorts <- ea1sa2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea1sa3ma_out_annual_cohorts <- ea1sa3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea2sa1ma_out_annual_cohorts <- ea2sa1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea2sa2ma_out_annual_cohorts <- ea2sa2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea2sa3ma_out_annual_cohorts <- ea2sa3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea3sa1ma_out_annual_cohorts <- ea3sa1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea3sa2ma_out_annual_cohorts <- ea3sa2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea3sa3ma_out_annual_cohorts <- ea3sa3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea1sb1ma_out_annual_cohorts <- ea1sb1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea1sb2ma_out_annual_cohorts <- ea1sb2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea1sb3ma_out_annual_cohorts <- ea1sb3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea2sb1ma_out_annual_cohorts <- ea2sb1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea2sb2ma_out_annual_cohorts <- ea2sb2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea2sb3ma_out_annual_cohorts <- ea2sb3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea3sb1ma_out_annual_cohorts <- ea3sb1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea3sb2ma_out_annual_cohorts <- ea3sb2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
ea3sb3ma_out_annual_cohorts <- ea3sb3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb1sa1ma_out_annual_cohorts <- eb1sa1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb1sa2ma_out_annual_cohorts <- eb1sa2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb1sa3ma_out_annual_cohorts <- eb1sa3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb2sa1ma_out_annual_cohorts <- eb2sa1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb2sa2ma_out_annual_cohorts <- eb2sa2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb2sa3ma_out_annual_cohorts <- eb2sa3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb3sa1ma_out_annual_cohorts <- eb3sa1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb3sa2ma_out_annual_cohorts <- eb3sa2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb3sa3ma_out_annual_cohorts <- eb3sa3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb1sb1ma_out_annual_cohorts <- eb1sb1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2))%>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb1sb2ma_out_annual_cohorts <- eb1sb2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb1sb3ma_out_annual_cohorts <- eb1sb3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb2sb1ma_out_annual_cohorts <- eb2sb1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb2sb2ma_out_annual_cohorts <- eb2sb2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb2sb3ma_out_annual_cohorts <- eb2sb3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb3sb1ma_out_annual_cohorts <- eb3sb1ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb3sb2ma_out_annual_cohorts <- eb3sb2ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
eb3sb3ma_out_annual_cohorts <- eb3sb3ma_out_annual_cohorts %>% mutate(dbhclass = cut(dbh ,breaks = seq(0,10,0.5),include.lowest = TRUE)) %>% mutate(basalArea = pi*(dbh/2)) %>% group_by(year) %>% mutate(highBA= map_dbl(basalArea,~sum(basalArea[basalArea>=.x]))-basalArea) %>%
...
dataBinWD <- rbind(simul_data$simuls[[12]][,c(28,31,23,32,33)], simul_data$simuls[[13]][,c(28,31,23,32,33)], simul_data$simuls[[14]][,c(28,31,23,32,33)])
