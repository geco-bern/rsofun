...
params_siml <- list(
      ...
      method_mortality      = "const_selfthin" # dbh or cstarvation or growthrate or const_selfthin or bal
      )
```
...
ea1sb3mc_out_hourly_tile <- out$output_hourly_tile
ea1sb3mc_out_daily_tile <- out$output_daily_tile
ea1sb3mc_out_daily_cohorts <- out$output_daily_cohorts
ea1sb3mc_out_annual_tile <- out$output_annual_tile
ea1sb3mc_out_annual_cohorts <- out$output_annual_cohorts
...
```{r}
setwd("/Users/lmarques/rsofun/Simulations_pmodel")
write.csv(ea1sb3mc_out_hourly_tile,   "ea1sb3mc_out_hourly_tile.csv")
write.csv(ea1sb3mc_out_daily_tile,    "ea1sb3mc_out_daily_tile.csv")
write.csv(ea1sb3mc_out_daily_cohorts, "ea1sb3mc_out_daily_cohorts.csv")
write.csv(ea1sb3mc_out_annual_tile,   "ea1sb3mc_out_annual_tile.csv")
write.csv(ea1sb3mc_out_annual_cohorts,"ea1sb3mc_out_annual_cohorts.csv")
```
