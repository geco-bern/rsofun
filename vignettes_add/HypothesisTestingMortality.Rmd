...
ggplot() + 
  ...
  ggtitle("Function of DBH gs-Leuning") + scale_y_continuous(limits = c(0,45))
...
ggplot() + 
  ...
  labs(x = "Year", y = expression(paste("Biomass (Kg C ", m^-2, " ", yr^-1, ") "))) + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Function of DBH p-model") + scale_y_continuous(limits = c(0,45))
...
# Mortality as a function of Self-thinning
ggplot() + 
  geom_point(data=subset(ea1sa1mdgl_out_annual_tile,year>=100), aes(x=log(QMD), y=log(Density12), color='Control')) + 
  geom_point(data=subset(ea2sa1mdgl_out_annual_tile,year>=100), aes(x=log(QMD), y=log(Density12), color='+15%')) +
  geom_point(data=subset(ea3sa1mdgl_out_annual_tile,year>=100), aes(x=log(QMD), y=log(Density12), color='+30%')) +
  scale_color_manual("Levels of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#00BA38", "#619CFF"))+
  labs(col = "Level of LUE", x = "Ln(QMD)", y = "Ln(N)") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Function of Growth rate gs-Leuning") 
...
ggplot() + 
  geom_point(data=subset(ea1sa1mdpm_out_annual_tile,year>=100), aes(x=log(QMD), y=log(Density12), color='Control')) + 
  geom_point(data=subset(ea2sa1mdpm_out_annual_tile,year>=100), aes(x=log(QMD), y=log(Density12), color='+15%')) +
  geom_point(data=subset(ea3sa1mdpm_out_annual_tile,year>=100), aes(x=log(QMD), y=log(Density12), color='+30%')) +
  scale_color_manual("Levels of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#00BA38", "#619CFF"))+
  labs(col = "Level of LUE", x = "Ln(QMD)", y = "Ln(N)") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Function of Growth rate p-model") 
