...
out$output_annual_tile %>% 
  ggplot() + geom_point(aes(x = log(DBH12), y = log(Density12))) +
  theme_classic()+labs(x = "log(QMD)", y = "log(Density12)") + scale_x_continuous(limits = c(-3,-1.5))
...
ggplot() + 
  ...
  labs(col = "Level of LUE", x = "Ln(QMD)", y = "Ln(N)") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Function of Constant Self-thinning gs-Leuning") + scale_x_continuous(limits = c(-3,0))
