...
sofun2_out_hourly_tile <- out$output_hourly_tile
sofun2_out_daily_tile <- out$output_daily_tile
sofun2_out_daily_cohorts <- out$output_daily_cohorts
sofun2_out_annual_tile <- out$output_annual_tile
sofun2_out_annual_cohorts <- out$output_annual_cohorts

#ea1sa1mapm_out_hourly_tile <- out$output_hourly_tile
#ea1sa1mapm_out_daily_tile <- out$output_daily_tile
#ea1sa1mapm_out_daily_cohorts <- out$output_daily_cohorts
#ea1sa1mapm_out_annual_tile <- out$output_annual_tile
#ea1sa1mapm_out_annual_cohorts <- out$output_annual_cohorts
