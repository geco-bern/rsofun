...
params_tile <- list(
  ...
  tf_base      = 1,
  par_mort     = 1.5   # param_dbh=0.6 param_csv=-2 param_gr=1 CAI_MAX=2
  )
...
ea1sa1mdgl_out_annual_tile  <- read.csv("/Users/lmarques/rsofun/Simulations_pmodel/ea1sa1mdgl_out_annual_tile.csv")
...
ggplot() + 
  geom_point(data=subset(ea1sa1mdpm_out_annual_tile,year>=1), aes(x=log(QMD), y=log(Density12), color='Control')) + 
  geom_point(data=subset(ea2sa1mdpm_out_annual_tile,year>=1), aes(x=log(QMD), y=log(Density12), color='+15%')) +
  geom_point(data=subset(ea3sa1mdpm_out_annual_tile,year>=1), aes(x=log(QMD), y=log(Density12), color='+30%')) +
  scale_color_manual("Levels of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#00BA38", "#619CFF"))+
  labs(col = "Level of LUE", x = "Ln(QMD)", y = "Ln(N)") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Function of Constant Self-thinning p-model") 
