...
ea1sa3me_out_hourly_tile <- out$output_hourly_tile
ea1sa3me_out_daily_tile <- out$output_daily_tile
ea1sa3me_out_daily_cohorts <- out$output_daily_cohorts
ea1sa3me_out_annual_tile <- out$output_annual_tile
ea1sa3me_out_annual_cohorts <- out$output_annual_cohorts
...
```{r}
setwd("/Users/lmarques/rsofun/Simulations_pmodel")
write.csv(ea1sa3me_out_hourly_tile,   "ea1sa3me_out_hourly_tile.csv")
write.csv(ea1sa3me_out_daily_tile,    "ea1sa3me_out_daily_tile.csv")
write.csv(ea1sa3me_out_daily_cohorts, "ea1sa3me_out_daily_cohorts.csv")
write.csv(ea1sa3me_out_annual_tile,   "ea1sa3me_out_annual_tile.csv")
write.csv(ea1sa3me_out_annual_cohorts,"ea1sa3me_out_annual_cohorts.csv")
```
...
ggplot() + 
  ...
  geom_line(data=ea1sb2ma_out_annual_tile, aes(x=year, y=plantC, color='phiRL = 6')) +
  geom_line(data=ea1sb3ma_out_annual_tile, aes(x=year, y=plantC, color='phiRL = 8')) +
...
ggplot() + 
  ...
  geom_line(data=ea1sb2mb_out_annual_tile, aes(x=year, y=plantC, color='phiRL = 6')) +
  geom_line(data=ea1sb3mb_out_annual_tile, aes(x=year, y=plantC, color='phiRL = 8')) +
  scale_color_manual("Levels of R:S", breaks = c("phiRL = 4", "phiRL = 6", "phiRL = 8"), values = c("#00AFBB", "#E7B800", "#FC4E07"))+
  labs(x = "Year", y = expression(paste("Biomass (Kg C ", m^-2, " ", yr^-1, ") "))) + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Mortality formulation Ratio NSC - Leaf mass")
...
ggplot() + 
  ...
  geom_line(data=ea1sb2mc_out_annual_tile, aes(x=year, y=plantC, color='phiRL = 6')) +
  geom_line(data=ea1sb3mc_out_annual_tile, aes(x=year, y=plantC, color='phiRL = 8')) +
  scale_color_manual("Levels of R:S", breaks = c("phiRL = 4", "phiRL = 6", "phiRL = 8"), values = c("#00AFBB", "#E7B800", "#FC4E07"))+
  labs(x = "Year", y = expression(paste("Biomass (Kg C ", m^-2, " ", yr^-1, ") "))) + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Mortality formulation Growth rate")
