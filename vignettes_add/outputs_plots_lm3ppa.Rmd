...
Bio_DBH_LUE <- ggplot() + 
  geom_line(data=ea1sa1DBHgl_out_annual_tile, aes(x=year, y=plantC, color='Low')) + 
  geom_line(data=ea2sa1DBHgl_out_annual_tile, aes(x=year, y=plantC, color='Medium')) +
  geom_line(data=ea3sa1DBHgl_out_annual_tile, aes(x=year, y=plantC, color='High')) +
  #scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38"))+
  scale_color_manual("Growth rate", breaks = c("Low", "Medium", "High"), values = c("#F8766D" ,"#619CFF", "#00BA38"))+
  ...
  scale_y_continuous(limits = c(0,45),breaks = seq(0,45,10)) #+ labs(title= "Tree mortality as fc. of size")
...
Bio_DBH_WD <- ggplot() + 
  ...
  labs(title= "Tree mortality as fc. of size")
