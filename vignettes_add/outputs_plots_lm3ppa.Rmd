...
fig1a_dbh_calib <- ggplot(data.frame(x = c(0, 1)), aes(x)) + 
  stat_function(fun = ~ 0.1000000 * 0.1*.x ^ 1.5, col="#009E73") +  
...
fig1a_nsc_calib <- ggplot(data.frame(x = c(0, 5)), aes(x)) + 
  stat_function(fun = ~ 1.494771 * 0.1*(exp(-3.0*.x)/(0.01+exp(-3.0*.x))), col="#009E73") +
...
fig1g_dbh <- ggplot() + 
  ...
  scale_color_manual("Parameter value", breaks = c("x1", "x2", "x3"), 
                     values = c("#009E73", "#0072B2", "#D55E00")) +
  scale_shape_manual("Level of LUE", breaks = c("0-15%","0-30%"), 
                     values = c(1,16)) +  labs(x="dG/G", y="dk/k") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
...
ggarrange(fig1a_dbh,fig1b_dbh,fig1c_dbh,fig1d_dbh,fig1e_dbh,fig1f_dbh,fig1g_dbh,fig1h_dbh,
          fig1a_nsc,fig1b_nsc,fig1c_nsc,fig1d_nsc,fig1e_nsc,fig1f_nsc,fig1g_nsc,fig1h_nsc,
          fig1a_nsc,fig1b_nsc,fig1c_nsc,fig1d_nsc,fig1e_nsc,fig1f_nsc,fig1g_nsc,fig1h_nsc,
          ncol = 4, nrow = 6, common.legend = T,legend="bottom")
