...
fig1a_dbh <- ggplot(data.frame(x = c(0, 1)), aes(x)) + 
  stat_function(fun = ~ 0.1*.x ^ 1.5, col="#0072B2") +
  stat_function(fun = ~ 0.1*.x ^ 2.5, col="#009E73") +
...
fig1a_nsc <- ggplot(data.frame(x = c(0, 5)), aes(x)) + 
  stat_function(fun = ~ 0.1*(exp(-3.0*.x)/(0.01+exp(-3.0*.x))), col="#0072B2") +
  stat_function(fun = ~ 0.1*(exp(-2.5*.x)/(0.01+exp(-2.5*.x))), col="#009E73") +
...
fig1a_gr <- ggplot(data.frame(x = c(0, 15)), aes(x)) + 
  stat_function(fun = ~ 0.1*(exp(0.8*.x)/(100+exp(0.8*.x))), col="#0072B2") +
  stat_function(fun = ~ 0.1*(exp(0.7*.x)/(100+exp(0.7*.x))), col="#009E73") +
  stat_function(fun = ~ 0.1*(exp(0.6*.x)/(100+exp(0.6*.x))), col="#D55E00") +
...
fig1c_dbh <- ggplot() + 
  ...
  geom_line(data=ea1sa1DBHgl_out_annual_tile, aes(x=year, y=c_deadtrees, color='Control'),alpha=.7) + 
  geom_line(data=ea2sa1DBHgl_out_annual_tile, aes(x=year, y=c_deadtrees, color='+15%'),alpha=.7) +
  geom_line(data=ea3sa1DBHgl_out_annual_tile, aes(x=year, y=c_deadtrees, color='+30%'),alpha=.7) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38")) +
  labs(x = "Year", y = "NPP and mortality") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
...
fig1c_nsc <- ggplot() + 
  geom_line(data=ea1sa1NSCgl_out_annual_tile, aes(x=year, y=NPP, color='Control'),alpha=.7) + 
  geom_line(data=ea2sa1NSCgl_out_annual_tile, aes(x=year, y=NPP, color='+15%'),alpha=.7) +
  geom_line(data=ea3sa1NSCgl_out_annual_tile, aes(x=year, y=NPP, color='+30%'),alpha=.7) +
  geom_line(data=ea1sa1NSCgl_out_annual_tile, aes(x=year, y=c_deadtrees, color='Control'),alpha=.7) + 
  geom_line(data=ea2sa1NSCgl_out_annual_tile, aes(x=year, y=c_deadtrees, color='+15%'),alpha=.7) +
  geom_line(data=ea3sa1NSCgl_out_annual_tile, aes(x=year, y=c_deadtrees, color='+30%'),alpha=.7) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38")) +
  labs(x = "Year", y = "NPP and mortality") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
fig1c_gr <- ggplot() + 
  geom_line(data=ea1sa1GRgl_out_annual_tile, aes(x=year, y=NPP, color='Control'),alpha=.7) + 
  geom_line(data=ea2sa1GRgl_out_annual_tile, aes(x=year, y=NPP, color='+15%'),alpha=.7) +
  geom_line(data=ea3sa1GRgl_out_annual_tile, aes(x=year, y=NPP, color='+30%'),alpha=.7) +
  geom_line(data=ea1sa1GRgl_out_annual_tile, aes(x=year, y=c_deadtrees, color='Control'),alpha=.7) + 
  geom_line(data=ea2sa1GRgl_out_annual_tile, aes(x=year, y=c_deadtrees, color='+15%'),alpha=.7) +
  geom_line(data=ea3sa1GRgl_out_annual_tile, aes(x=year, y=c_deadtrees, color='+30%'),alpha=.7) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38")) +
  labs(x = "Year", y = "NPP and mortality") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
fig1d_dbh <- ggplot() + 
  ...
  scale_shape_manual("Level of LUE", breaks = c("0-15%","0-30%"), 
                     values = c(16,1)) +  labs(x="dNPP/NPP", y="dB/B") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
...
# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea3sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP30=mean(NPP))  #NPP or A_NPP
NPP15 <- ea2sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP15=mean(NPP))  
NPP0  <- ea1sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP0=mean(NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
dNPP0_30 <- (NPP30$NPP30 - NPP0$NPP0)/NPP0$NPP0

M30 <- ea3sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(M30=mean(c_deadtrees)) #plantC or A_Biomass
M15 <- ea2sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(M15=mean(c_deadtrees))
M0  <- ea1sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(M0=mean(c_deadtrees))
...
fig1e_dbh <- ggplot() + 
  geom_point(data=DBHgl_RelChange_0_15, aes(x=dNPP0_15, y=dM0_15, color='0-15%')) + 
  geom_point(data=DBHgl_RelChange_0_30, aes(x=dNPP0_30, y=dM0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dM/M") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
  scale_x_continuous(limits = c(0,0.7)) + scale_y_continuous(limits = c(0,0.7)) +
  ggtitle("e)") + geom_abline(slope=1, intercept = 0.0, linetype="dashed")

# Mortality as a function of NSC

# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP30=mean(NPP))
NPP15 <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP15=mean(NPP))
NPP0  <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP0=mean(NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
dNPP0_30 <- (NPP30$NPP30 - NPP0$NPP0)/NPP0$NPP0

M30 <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(M30=mean(c_deadtrees)) #plantC or A_Biomass
M15 <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(M15=mean(c_deadtrees))
M0  <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(M0=mean(c_deadtrees))
dM0_15 <- (M15$M15 - M0$M0)/M0$M0
dM15_30 <- (M30$M30 - M15$M15)/M15$M15
dM0_30 <- (M30$M30 - M0$M0)/M0$M0
...
fig1e_nsc <- ggplot() + 
  geom_point(data=NSCgl_RelChange_0_15, aes(x=dNPP0_15, y=dM0_15, color='0-15%')) + 
  geom_point(data=NSCgl_RelChange_0_30, aes(x=dNPP0_30, y=dM0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dM/M") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP30=mean(NPP))
NPP15 <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP15=mean(NPP))
NPP0  <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP0=mean(NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
dNPP0_30 <- (NPP30$NPP30 - NPP0$NPP0)/NPP0$NPP0

M30 <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(M30=mean(c_deadtrees)) #plantC or A_Biomass
M15 <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(M15=mean(c_deadtrees))
M0  <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(M0=mean(c_deadtrees))
dM0_15 <- (M15$M15 - M0$M0)/M0$M0
dM15_30 <- (M30$M30 - M15$M15)/M15$M15
dM0_30 <- (M30$M30 - M0$M0)/M0$M0
...
fig1e_gr <- ggplot() + 
  geom_point(data=GRgl_RelChange_0_15, aes(x=dNPP0_15, y=dM0_15, color='0-15%')) + 
  geom_point(data=GRgl_RelChange_0_30, aes(x=dNPP0_30, y=dM0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dM/M") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
k30 <- ea3sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(k30=mean(1/c_turnover_time)) 
k15 <- ea2sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(k15=mean(1/c_turnover_time))
k0  <- ea1sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(k0=mean(1/c_turnover_time))
...
fig1f_dbh <- ggplot() + 
  geom_point(data=DBHgl_RelChange_0_15, aes(x=dNPP0_15, y=dk0_15, color='0-15%')) + 
  geom_point(data=DBHgl_RelChange_0_30, aes(x=dNPP0_30, y=dk0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
...
k30 <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(k30=mean(1/c_turnover_time)) 
k15 <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(k15=mean(1/c_turnover_time))
k0  <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(k0=mean(1/c_turnover_time))
dk0_15 <- (k15$k15 - k0$k0)/k0$k0
dk15_30 <- (k30$k30 - k15$k15)/k15$k15
dk0_30 <- (k30$k30 - k0$k0)/k0$k0
...
fig1f_nsc <- ggplot() + 
  geom_point(data=NSCgl_RelChange_0_15, aes(x=dNPP0_15, y=dk0_15, color='0-15%')) + 
  geom_point(data=NSCgl_RelChange_0_30, aes(x=dNPP0_30, y=dk0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dk/k") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
k30 <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(k30=mean(1/c_turnover_time)) 
k15 <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(k15=mean(1/c_turnover_time))
k0  <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(k0=mean(1/c_turnover_time))
dk0_15 <- (k15$k15 - k0$k0)/k0$k0
dk15_30 <- (k30$k30 - k15$k15)/k15$k15
dk0_30 <- (k30$k30 - k0$k0)/k0$k0
...
fig1f_gr <- ggplot() + 
  geom_point(data=GRgl_RelChange_0_15, aes(x=dNPP0_15, y=dk0_15, color='0-15%')) + 
  geom_point(data=GRgl_RelChange_0_30, aes(x=dNPP0_30, y=dk0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dk/k") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
# Mortality as a function of DBH
Tau_DBH_LUE <- ggplot() + 
  geom_line(data=ea1sa1DBHgl_out_annual_tile, aes(x=year, y=c_turnover_time, color='Control')) + 
  geom_line(data=ea2sa1DBHgl_out_annual_tile, aes(x=year, y=c_turnover_time, color='+15%')) +
  geom_line(data=ea3sa1DBHgl_out_annual_tile, aes(x=year, y=c_turnover_time, color='+30%')) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38"))+
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
  labs(title= "Size-dependent mortality")

# Mortality as a function of C starvation
Tau_NSC_LUE <- ggplot() + 
  geom_line(data=ea1sa1NSCgl_out_annual_tile, aes(x=year, y=c_turnover_time, color='Control')) + 
  geom_line(data=ea2sa1NSCgl_out_annual_tile, aes(x=year, y=c_turnover_time, color='+15%')) +
  geom_line(data=ea3sa1NSCgl_out_annual_tile, aes(x=year, y=c_turnover_time, color='+30%')) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38"))+
  labs(x = "Year", y = expression(paste("Carbon turnover time ( ", tau, " , ", yr, ") "))) + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
# Mortality as a function of DBH
ea1sa1DBHgl_out_annual_tileMaxAgg <- ea1sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
...
ea2sa1DBHgl_out_annual_tileMaxAgg <- ea2sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T),
          NPP_mean=mean(NPP,na.rm=T), NPP_sd=sd(NPP,na.rm=T))

ea3sa1DBHgl_out_annual_tileMaxAgg <- ea3sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T),
          NPP_mean=mean(NPP,na.rm=T), NPP_sd=sd(NPP,na.rm=T))

fig1g1_dbh <- ggplot() + 
  geom_point(data=ea1sa1DBHgl_out_annual_tileMaxAgg, aes(x=NPP_mean, y=maxAge_mean, color='Control')) + 
  geom_point(data=ea2sa1DBHgl_out_annual_tileMaxAgg, aes(x=NPP_mean, y=maxAge_mean, color='+15%')) +
  geom_point(data=ea3sa1DBHgl_out_annual_tileMaxAgg, aes(x=NPP_mean, y=maxAge_mean, color='+30%')) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38"))+
...
L30 <- ea3sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(L30=mean(MaxAge))
L15 <- ea2sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(L15=mean(MaxAge))
L0  <- ea1sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(L0=mean(MaxAge))
...
fig1g2_dbh <- ggplot() + 
  geom_point(data=DBHgl_RelChange_0_15, aes(x=dNPP0_15, y=dL0_15, color='0-15%')) + 
  geom_point(data=DBHgl_RelChange_0_30, aes(x=dNPP0_30, y=dL0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
...
# Mortality as a function of NSC
ea1sa1NSCgl_out_annual_tileMaxAgg <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T),
          NPP_mean=mean(NPP,na.rm=T), NPP_sd=sd(NPP,na.rm=T))

ea2sa1NSCgl_out_annual_tileMaxAgg <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T),
          NPP_mean=mean(NPP,na.rm=T), NPP_sd=sd(NPP,na.rm=T))

ea3sa1NSCgl_out_annual_tileMaxAgg <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T),
          NPP_mean=mean(NPP,na.rm=T), NPP_sd=sd(NPP,na.rm=T))

fig1g1_nsc <- ggplot() + 
  geom_point(data=ea1sa1NSCgl_out_annual_tileMaxAgg, aes(x=NPP_mean, y=maxAge_mean, color='Control')) + 
  geom_point(data=ea2sa1NSCgl_out_annual_tileMaxAgg, aes(x=NPP_mean, y=maxAge_mean, color='+15%')) +
  geom_point(data=ea3sa1NSCgl_out_annual_tileMaxAgg, aes(x=NPP_mean, y=maxAge_mean, color='+30%')) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38"))+
  labs(x = expression(paste("NPP (Kg C ",yr^-1,  ") ")), y = "Longevity (years)") +  
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP30=mean(NPP))  #NPP or A_NPP
NPP15 <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP15=mean(NPP))  
NPP0  <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP0=mean(NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
...
L30 <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(L30=mean(MaxAge))
L15 <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(L15=mean(MaxAge))
L0  <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(L0=mean(MaxAge))
dL0_15 <- (L15$L15 - L0$L0)/L0$L0
dL15_30 <- (L30$L30 - L15$L15)/L15$L15
dL0_30 <- (L30$L30 - L0$L0)/L0$L0
...
fig1g2_nsc <- ggplot() + 
  geom_point(data=NSCgl_RelChange_0_15, aes(x=dNPP0_15, y=dL0_15, color='0-15%')) + 
  geom_point(data=NSCgl_RelChange_0_30, aes(x=dNPP0_30, y=dL0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dL/L") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
ea1sa1GRgl_out_annual_tileMaxAgg <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T),
          NPP_mean=mean(NPP,na.rm=T), NPP_sd=sd(NPP,na.rm=T))

ea2sa1GRgl_out_annual_tileMaxAgg <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T),
          NPP_mean=mean(NPP,na.rm=T), NPP_sd=sd(NPP,na.rm=T))

ea3sa1GRgl_out_annual_tileMaxAgg <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T),
          NPP_mean=mean(NPP,na.rm=T), NPP_sd=sd(NPP,na.rm=T))

fig1g1_gr <- ggplot() + 
  geom_point(data=ea1sa1GRgl_out_annual_tileMaxAgg, aes(x=NPP_mean, y=maxAge_mean, color='Control')) + 
  geom_point(data=ea2sa1GRgl_out_annual_tileMaxAgg, aes(x=NPP_mean, y=maxAge_mean, color='+15%')) +
  geom_point(data=ea3sa1GRgl_out_annual_tileMaxAgg, aes(x=NPP_mean, y=maxAge_mean, color='+30%')) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38"))+
  labs(x = expression(paste("NPP (Kg C ",yr^-1,  ") ")), y = "Longevity (years)") +  
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP30=mean(NPP))  #NPP or A_NPP
NPP15 <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP15=mean(NPP))  
NPP0  <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP0=mean(NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
...
L30 <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(L30=mean(MaxAge)) 
L15 <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(L15=mean(MaxAge))
L0  <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(L0=mean(MaxAge))
dL0_15 <- (L15$L15 - L0$L0)/L0$L0
dL15_30 <- (L30$L30 - L15$L15)/L15$L15
dL0_30 <- (L30$L30 - L0$L0)/L0$L0
...
fig1g2_gr <- ggplot() + 
  geom_point(data=GRgl_RelChange_0_15, aes(x=dNPP0_15, y=dL0_15, color='0-15%')) + 
  geom_point(data=GRgl_RelChange_0_30, aes(x=dNPP0_30, y=dL0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dL/L") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
fig1h_dbh <- ggplot() + 
  geom_point(data=subset(data1, year>=750), aes(x=log(QMD), y=log(Density12), color=as.factor(LevelLUE)),alpha=1) + 
  geom_smooth(data=subset(data1, year>=750), aes(x=log(QMD), y=log(Density12), color=as.factor(LevelLUE)),method = "lm",fullrange = T) +
...
fig1h_nsc <-  ggplot() + 
  geom_point(data=subset(data1, year>=750), aes(x=log(QMD), y=log(Density12), color=as.factor(LevelLUE))) +
  geom_smooth(data=subset(data1, year>=750), aes(x=log(QMD), y=log(Density12), color=as.factor(LevelLUE)),method = "lm",fullrange = T) +
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        plot.title = element_text(size = 11)) +    
  ggtitle("h)") #+ 
 # scale_x_continuous(limits = c(2.5,3.6),breaks = seq(2.5,3.5,0.2)) + 
 # scale_y_continuous(limits = c(3.1,8.8),breaks = seq(4,8,1))
...
fig1h_gr <- ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        plot.title = element_text(size = 11)) +    
  ggtitle("h)") #+
  #scale_x_continuous(limits = c(2.5,3.2),breaks = seq(2.5,3.2,0.1)) + 
  #scale_y_continuous(limits = c(3.1,8.8),breaks = seq(4,8,1))
...
ggarrange(fig1a_dbh,fig1b_dbh,fig1c_dbh,fig1d_dbh,fig1e_dbh,fig1f_dbh,fig1g_dbh,fig1h_dbh, ncol = 8, nrow = 1, common.legend = T,legend="bottom")

ggarrange(fig1a_dbh,fig1b_dbh,fig1c_dbh,fig1d_dbh,fig1e_dbh, ncol = 5, nrow = 1, common.legend = T,legend="bottom")
ggarrange(fig1f_dbh,fig1g1_dbh,fig1g2_dbh,fig1h_dbh, ncol = 4, nrow = 1, common.legend = T,legend="bottom")
