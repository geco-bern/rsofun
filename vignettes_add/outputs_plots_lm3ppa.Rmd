...
fig1b_dbh <- ggplot() + 
  geom_line(data=ea1sa1DBHgl_out_annual_tile, aes(x=year, y=plantC, color='Control'),alpha=.7) + 
  geom_line(data=ea2sa1DBHgl_out_annual_tile, aes(x=year, y=plantC, color='+15%'),alpha=.7) +
  geom_line(data=ea3sa1DBHgl_out_annual_tile, aes(x=year, y=plantC, color='+30%'),alpha=.7) +
...
#ggsave("plotBio_DBH_LUE.tiff", width = 4.5, height = 4, device='tiff', dpi=300)
...
B30 <- ea3sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(B30=mean(plantC)) #plantC or A_Biomass
B15 <- ea2sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(B15=mean(plantC))
B0  <- ea1sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(B0=mean(plantC))
...
fig1d_dbh <- ggplot() + 
  geom_point(data=DBHgl_RelChange_0_15, aes(x=dNPP0_15, y=dB0_15, color='0-15%')) + 
  geom_point(data=DBHgl_RelChange_0_30, aes(x=dNPP0_30, y=dB0_30, color='0-30%')) + 
...
B30 <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(B30=mean(plantC))
B15 <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(B15=mean(plantC))
B0  <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(B0=mean(plantC))
dB0_15 <- (B15$B15 - B0$B0)/B0$B0
dB15_30 <- (B30$B30 - B15$B15)/B15$B15
dB0_30 <- (B30$B30 - B0$B0)/B0$B0
...
fig1d_nsc <- ggplot() + 
  geom_point(data=NSCgl_RelChange_0_15, aes(x=dNPP0_15, y=dB0_15, color='0-15%')) + 
  geom_point(data=NSCgl_RelChange_0_30, aes(x=dNPP0_30, y=dB0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dB/B")+
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) +   scale_x_continuous(limits = c(0,0.5)) + scale_y_continuous(limits = c(0,0.5)) +
  ggtitle("d)") + geom_abline(slope=1, intercept = 0.0, linetype="dashed")
...
B30 <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(B30=mean(plantC))
B15 <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(B15=mean(plantC))
B0  <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(B0=mean(plantC))
dB0_15 <- (B15$B15 - B0$B0)/B0$B0
dB15_30 <- (B30$B30 - B15$B15)/B15$B15
dB0_30 <- (B30$B30 - B0$B0)/B0$B0
...
fig1d_gr <- ggplot() + 
  geom_point(data=GRgl_RelChange_0_15, aes(x=dNPP0_15, y=dB0_15, color='0-15%')) + 
  geom_point(data=GRgl_RelChange_0_30, aes(x=dNPP0_30, y=dB0_30, color='0-30%')) + 
  scale_color_manual("Level of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dB/B")+
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
