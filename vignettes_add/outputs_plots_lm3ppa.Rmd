...
#### DBH
```{r, include=F, eval=T,fig.height=6,fig.width=12}
...
#### GR
```{r, include=F, eval=T,fig.height=6,fig.width=12}
ggarrange(fig1a_gr,fig1b_gr,fig1c_gr,fig1d_gr,fig1e_gr,fig1f_gr,fig1g_gr,fig1h_gr, ncol = 4, nrow = 2, common.legend = T,legend="none")
...
fig1 <- ggarrange(fig1a_dbh_calib,fig1b_dbh,fig1c_dbh,fig1d_dbh,fig1e_dbh,fig1f_dbh,fig1g_dbh,fig1h_dbh,
          fig1a_nsc_calib,fig1b_nsc,fig1c_nsc,fig1d_nsc,fig1e_nsc,fig1f_nsc,fig1g_nsc,fig1h_nsc,
          fig1a_gr_calib,fig1b_gr,fig1c_gr,fig1d_gr,fig1e_gr,fig1f_gr,fig1g_gr,fig1h_gr,
          ncol = 4, nrow = 6, common.legend = T,legend="none")
legs <- ggarrange(leg1,leg2, ncol = 2, nrow = 1,align = "h")

ggarrange(fig1,legs, ncol = 1, nrow = 2,align = "v",heights = c(1,0.05))

ggsave("figure1.png", width = 12, height = 17, device='tiff', dpi=300)
```
...
ggsave("figure2.png", width = 10, height = 10, device='tiff', dpi=300)
```
