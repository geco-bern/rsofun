...
dB_dNPP_DBH_LUE <- ggplot() + 
  ...
  scale_color_manual("Levels of LUE", breaks = c("0-15%", "0-30%"), values = c("#619CFF" ,"#00BA38"))+
  labs(x="dNPP/NPP", y="dB/B")+
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  scale_x_continuous(limits = c(0,0.5)) + scale_y_continuous(limits = c(0,0.5)) +
  ggtitle("Mortality formulation DBH") + geom_abline(slope=1, intercept = 0.0, linetype="dashed")
...
# Mortality as a function of NSC
data1 <- rbind(ea1sa1NSCgl_out_annual_tile[,-59], ea2sa1NSCgl_out_annual_tile, ea3sa1NSCgl_out_annual_tile)
stl_NSC_LUE <-  ggplot() + 
