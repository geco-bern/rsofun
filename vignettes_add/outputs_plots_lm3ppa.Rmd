...
# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea3sa1NSCp2gl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP30=mean(NPP))  #NPP or A_NPP
NPP15 <- ea2sa1DNSCp2gl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP15=mean(NPP))  
NPP0  <- ea1sa1NSCp2gl_out_annual_tile %>% dplyr::filter(year>=700&year<=1500) %>% summarise(NPP0=mean(NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
dNPP0_30 <- (NPP30$NPP30 - NPP0$NPP0)/NPP0$NPP0
...
fig1i_dbh <- ggplot() + 
  geom_point(data= subset(ea1sa1DBHp1gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x1', shape='Control'),alpha=.7) + 
  geom_smooth(data= subset(ea1sa1DBHp1gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x1', linetype='Control'),
              method = "lm",fullrange = T) + 
  geom_point(data=subset(ea1sa1DBHp2gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x2', shape='Control'),alpha=.7) +
  geom_smooth(data= subset(ea1sa1DBHp2gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x2', linetype='Control'),
              method = "lm",fullrange = T) +
  geom_point(data=subset(ea1sa1DBHp3gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x3', shape='Control'),alpha=.7) +
  geom_smooth(data= subset(ea1sa1DBHp3gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x3', linetype='Control'),
              method = "lm",fullrange = T) +
  geom_point(data=subset(ea2sa1DBHp1gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x1', shape='+15%'),alpha=.7) + 
  geom_smooth(data= subset(ea2sa1DBHp1gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x1', linetype='+15%'),
              method = "lm",fullrange = T) +
  geom_point(data=subset(ea2sa1DBHp2gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x2', shape='+15%'),alpha=.7) +
  geom_smooth(data= subset(ea2sa1DBHp2gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x2', linetype='+15%'),
              method = "lm",fullrange = T) +
  geom_point(data=subset(ea2sa1DBHp3gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x3', shape='+15%'),alpha=.7) +
  geom_smooth(data= subset(ea2sa1DBHp3gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x3', linetype='+15%'),
              method = "lm",fullrange = T) +
  geom_point(data=subset(ea3sa1DBHp1gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x1', shape='+30%'),alpha=.7) + 
  geom_smooth(data= subset(ea3sa1DBHp1gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x1', linetype='+30%'),
              method = "lm",fullrange = T) +
  geom_point(data=subset(ea3sa1DBHp2gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x2', shape='+30%'),alpha=.7) +
  geom_smooth(data= subset(ea3sa1DBHp2gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x2', linetype='+30%'),
              method = "lm",fullrange = T) +
  geom_point(data=subset(ea3sa1DBHp3gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x3', shape='+30%'),alpha=.7) +
  geom_smooth(data= subset(ea3sa1DBHp3gl_out_annual_tile, year>=750), aes(x=log(QMD), y=log(Density12), color='x3', linetype='+30%'),
              method = "lm",fullrange = T) +
  scale_color_manual("Parameter value", breaks = c("x1", "x2", "x3"), 
                     values = c("#009E73", "#0072B2", "#D55E00")) +
...
ggarrange(fig1a_nsc,fig1b_nsc,fig1c_nsc,fig1d_nsc,fig1e_nsc,fig1f_nsc,fig1g_nsc,fig1h_nsc, ncol = 8, nrow = 1, common.legend = T,legend="bottom")

ggarrange(fig1a_nsc,fig1b_nsc,fig1c_nsc,fig1d_nsc,fig1e_nsc, ncol = 5, nrow = 1, common.legend = T,legend="bottom")
ggarrange(fig1f_nsc,fig1g1_nsc,fig1g2_nsc,fig1h_nsc, ncol = 4, nrow = 1, common.legend = T,legend="bottom")
...
#### GR
```{r, include=F, eval=T,fig.height=3,fig.width=16}
ggarrange(fig1a_gr,fig1b_gr,fig1c_gr,fig1d_gr,fig1e_gr,fig1f_gr,fig1g_gr,fig1h_gr, ncol = 8, nrow = 1, common.legend = T,legend="bottom")

ggarrange(fig1a_gr,fig1b_gr,fig1c_gr,fig1d_gr,fig1e_gr, ncol = 5, nrow = 1, common.legend = T,legend="bottom")
ggarrange(fig1f_gr,fig1g1_gr,fig1g2_gr,fig1h_gr, ncol = 4, nrow = 1, common.legend = T,legend="bottom")
