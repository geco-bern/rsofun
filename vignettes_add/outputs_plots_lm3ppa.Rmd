...
### 1. Stand develop: Stand biomass vs. time
...
Bio_NSC_LUE <- ggplot() + 
  ...
  labs(title= "b) C starvation mortality")
...
Bio_GR_LUE <- ggplot() + 
  ...
  labs(title= "c) Growth rate mortality") 
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(Bio_DBH_LUE,Bio_NSC_LUE,Bio_GR_LUE, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_bio_lue.tiff", width = 9, height = 3, device='tiff', dpi=300)
```
...
### 2. Relative change Aboveground NPP vs. Aboveground Biomass
...
NPP30 <- ea3sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP30=mean(A_NPP))
NPP15 <- ea2sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP15=mean(A_NPP))
NPP0  <- ea1sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP0=mean(A_NPP))
...
B30 <- ea3sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B30=mean(A_Biomass))
B15 <- ea2sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B15=mean(A_Biomass))
B0  <- ea1sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B0=mean(A_Biomass))
...
dB_dNPP_DBH_LUE <- ggplot() + 
  ...
  ggtitle("Tree mortality as fc. of size") + geom_abline(slope=1, intercept = 0.0, linetype="dashed")

# Mortality as a function of NSC

# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP30=mean(A_NPP))
NPP15 <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP15=mean(A_NPP))
NPP0  <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP0=mean(A_NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
dNPP0_30 <- (NPP30$NPP30 - NPP0$NPP0)/NPP0$NPP0

B30 <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B30=mean(A_Biomass))
B15 <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B15=mean(A_Biomass))
B0  <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B0=mean(A_Biomass))
dB0_15 <- (B15$B15 - B0$B0)/B0$B0
dB15_30 <- (B30$B30 - B15$B15)/B15$B15
dB0_30 <- (B30$B30 - B0$B0)/B0$B0
...
dB_dNPP_NSC_LUE <- ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  #scale_x_continuous(limits = c(0,0.5)) + scale_y_continuous(limits = c(0,0.5)) +
  ggtitle("Tree mortality as fc. of C starvation") #+ geom_abline(slope=1, intercept = 0.0, linetype="dashed")

# Mortality as a function of NSC

# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP30=mean(A_NPP))
NPP15 <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP15=mean(A_NPP))
NPP0  <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP0=mean(A_NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
dNPP0_30 <- (NPP30$NPP30 - NPP0$NPP0)/NPP0$NPP0

B30 <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B30=mean(A_Biomass))
B15 <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B15=mean(A_Biomass))
B0  <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B0=mean(A_Biomass))
dB0_15 <- (B15$B15 - B0$B0)/B0$B0
dB15_30 <- (B30$B30 - B15$B15)/B15$B15
dB0_30 <- (B30$B30 - B0$B0)/B0$B0
...
dB_dNPP_GR_LUE <- ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  #scale_x_continuous(limits = c(0,0.5)) + scale_y_continuous(limits = c(0,0.5)) +
  ggtitle("Tree mortality as fc. of growth rate") #+ geom_abline(slope=1, intercept = 0.0, linetype="dashed")
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(dB_dNPP_DBH_LUE,dB_dNPP_NSC_LUE,dB_dNPP_GR_LUE, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_dB_dNPP_lue.tiff", width = 9, height = 3, device='tiff', dpi=300)
```

### 3. Carbon Turnover time vs. time
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(Tau_DBH_LUE,Tau_NSC_LUE,Tau_GR_LUE, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_tau_lue.tiff", width = 9, height = 3, device='tiff', dpi=300)
```

### 4. Self-thinning relationship
...
stl_DBH_LUE <- ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        plot.title = element_text(size = 12)) #+ ggtitle("Tree mortality as fc. of size") #+ 
  #scale_x_continuous(limits = c(3.4,4.1),breaks = seq(3.5,4,0.1)) + 
  #scale_y_continuous(limits = c(4.5,6.5),breaks = seq(4,7,1))

ggsave("plotstl_DBH_LUE.tiff", width = 4.5, height = 4, device='tiff', dpi=300)
...
stl_NSC_LUE <-  ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) +   ggtitle("Tree mortality as fc. of C starvation") #+ 
...
stl_GR_LUE <- ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) +   ggtitle("Tree mortality as fc. of growth rate") #+
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(stl_DBH_LUE,stl_NSC_LUE,stl_GR_LUE, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_stl_lue.tiff", width = 9, height = 3, device='tiff', dpi=300)
```

### 5. Longevity vs. growth rates
...
# Mortality as a function of DBH
ea1sa1DBHgl_out_annual_tileMaxAgg <- ea1sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

ea2sa1DBHgl_out_annual_tileMaxAgg <- ea2sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),DBH_mean=mean(DBH,na.rm=T), DBH_sd=sd(DBH,na.rm=T),MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

ea3sa1DBHgl_out_annual_tileMaxAgg <- ea3sa1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),DBH_mean=mean(DBH,na.rm=T), DBH_sd=sd(DBH,na.rm=T),MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))
...
long_DBH_LUE <-ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
  labs(title= "Tree mortality as a fc. of size")

# Mortality as a function of NSC
ea1sa1NSCgl_out_annual_tileMaxAgg <- ea1sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

ea2sa1NSCgl_out_annual_tileMaxAgg <- ea2sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),DBH_mean=mean(DBH,na.rm=T), DBH_sd=sd(DBH,na.rm=T),MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

ea3sa1NSCgl_out_annual_tileMaxAgg <- ea3sa1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),DBH_mean=mean(DBH,na.rm=T), DBH_sd=sd(DBH,na.rm=T),MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

long_NSC_LUE <-ggplot() + 
  geom_point(data=ea1sa1NSCgl_out_annual_tileMaxAgg, aes(x=MaxDBH_MaxAge_mean, y=maxAge_mean, color='Control')) + 
  geom_point(data=ea2sa1NSCgl_out_annual_tileMaxAgg, aes(x=MaxDBH_MaxAge_mean, y=maxAge_mean, color='+15%')) +
  geom_point(data=ea3sa1NSCgl_out_annual_tileMaxAgg, aes(x=MaxDBH_MaxAge_mean, y=maxAge_mean, color='+30%')) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38"))+
  labs(x = expression(paste("Growth rate (mm ",yr^-1,  ") ")), y = "Longevity") +  
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
# Mortality as a function of GR
ea1sa1GRgl_out_annual_tileMaxAgg <- ea1sa1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

ea2sa1GRgl_out_annual_tileMaxAgg <- ea2sa1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),DBH_mean=mean(DBH,na.rm=T), DBH_sd=sd(DBH,na.rm=T),MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

ea3sa1GRgl_out_annual_tileMaxAgg <- ea3sa1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),DBH_mean=mean(DBH,na.rm=T), DBH_sd=sd(DBH,na.rm=T),MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

long_GR_LUE <-ggplot() + 
  geom_point(data=ea1sa1GRgl_out_annual_tileMaxAgg, aes(x=MaxDBH_MaxAge_mean, y=maxAge_mean, color='Control')) + 
  geom_point(data=ea2sa1GRgl_out_annual_tileMaxAgg, aes(x=MaxDBH_MaxAge_mean, y=maxAge_mean, color='+15%')) +
  geom_point(data=ea3sa1GRgl_out_annual_tileMaxAgg, aes(x=MaxDBH_MaxAge_mean, y=maxAge_mean, color='+30%')) +
  scale_color_manual("Level of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#619CFF", "#00BA38"))+
  labs(x = expression(paste("Growth rate (mm ",yr^-1,  ") ")), y = "Longevity") +  
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(long_DBH_LUE,long_NSC_LUE,long_GR_LUE, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_long_lue.tiff", width = 9, height = 3, device='tiff', dpi=300)
```
...
Bio_NSC_WD <- ggplot() + 
  ...
  labs(title= "Tree mortality as fc. of C starvation")
...
Bio_GR_WD <- ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        plot.title = element_text(size = 11)) + 
  #scale_y_continuous(limits = c(0,35),breaks = seq(0,35,10)) +
  labs(title= "Tree mortality as fc. of growth rate")
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(Bio_DBH_WD,Bio_NSC_WD,Bio_GR_WD, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_dbh_wd.tiff", width = 9, height = 3, device='tiff', dpi=300)
```
...
# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea1sb3DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP30=mean(A_NPP))
NPP15 <- ea1sb2DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP15=mean(A_NPP))
NPP0  <- ea1sb1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP0=mean(A_NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
dNPP0_30 <- (NPP30$NPP30 - NPP0$NPP0)/NPP0$NPP0

B30 <- ea1sb3DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B30=mean(A_Biomass))
B15 <- ea1sb2DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B15=mean(A_Biomass))
B0  <- ea1sb1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B0=mean(A_Biomass))
dB0_15 <- (B15$B15 - B0$B0)/B0$B0
dB15_30 <- (B30$B30 - B15$B15)/B15$B15
dB0_30 <- (B30$B30 - B0$B0)/B0$B0
...
dB_dNPP_DBH_WD <- ggplot() + 
  ...
  scale_color_manual("Levels of WD", breaks = c("300-450 kgC m-3", "300-600 kgC m-3"), values = c("#E7B800", "#FC4E07"))+
  labs(x="dNPP/NPP", y="dB/B")+
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
...
ggplot() + 
  geom_line(data=ea1sb1NSCgl_out_annual_tile, aes(x=year, y=A_Biomass, color='300 kgC m-3')) +
  geom_line(data=ea1sb2NSCgl_out_annual_tile, aes(x=year, y=A_Biomass, color='450 kgC m-3')) +
  geom_line(data=ea1sb3NSCgl_out_annual_tile, aes(x=year, y=A_Biomass, color='600 kgC m-3')) +
  scale_color_manual("Levels of WD", breaks = c("300 kgC m-3", "450 kgC m-3", "600 kgC m-3"), values = c("#00AFBB", "#E7B800", "#FC4E07"))

# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea1sb3NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP30=mean(A_NPP))
NPP15 <- ea1sb2NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP15=mean(A_NPP))
NPP0  <- ea1sb1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP0=mean(A_NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
dNPP0_30 <- (NPP30$NPP30 - NPP0$NPP0)/NPP0$NPP0

B30 <- ea1sb3NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B30=mean(A_Biomass))
B15 <- ea1sb2NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B15=mean(A_Biomass))
B0  <- ea1sb1NSCgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B0=mean(A_Biomass))
dB0_15 <- (B15$B15 - B0$B0)/B0$B0
dB15_30 <- (B30$B30 - B15$B15)/B15$B15
dB0_30 <- (B30$B30 - B0$B0)/B0$B0
...
dB_dNPP_NSC_WD <- ggplot() + 
  ...
  labs(x="dNPP/NPP", y="dB/B") +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  scale_x_continuous(limits = c(0,0.75)) + scale_y_continuous(limits = c(0,0.05)) +
  ggtitle("Tree mortality as a function of C starvation") + geom_abline(slope=1, intercept = 0.0, linetype="dashed")

# Mortality as a function of DBH

# Calculate the relative change as (Final value - initial value)/initial value
NPP30 <- ea1sb3GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP30=mean(A_NPP))
NPP15 <- ea1sb2GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP15=mean(A_NPP))
NPP0  <- ea1sb1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(NPP0=mean(A_NPP))
dNPP0_15 <- (NPP15$NPP15 - NPP0$NPP0)/NPP0$NPP0
dNPP15_30 <- (NPP30$NPP30 - NPP15$NPP15)/NPP15$NPP15
dNPP0_30 <- (NPP30$NPP30 - NPP0$NPP0)/NPP0$NPP0

B30 <- ea1sb3GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B30=mean(A_Biomass))
B15 <- ea1sb2GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B15=mean(A_Biomass))
B0  <- ea1sb1GRgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1800) %>% summarise(B0=mean(A_Biomass))
dB0_15 <- (B15$B15 - B0$B0)/B0$B0
dB15_30 <- (B30$B30 - B15$B15)/B15$B15
dB0_30 <- (B30$B30 - B0$B0)/B0$B0
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(dB_dNPP_DBH_WD,dB_dNPP_NSC_WD,dB_dNPP_GR_WD, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_dB_dNPP_wd.tiff", width = 9, height = 3, device='tiff', dpi=300)
```
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(Tau_DBH_LUE,Tau_NSC_LUE,Tau_GR_LUE, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_tau_wd.tiff", width = 9, height = 3, device='tiff', dpi=300)
```
...
stl_DBH_WD <- ggplot() + 
  geom_point(data=subset(data1, year>=500), aes(x=log(QMD), y=log(Density12), color=as.factor(LevelWD)),alpha=1) + 
  geom_smooth(data=subset(data1, year>=500), aes(x=log(QMD), y=log(Density12), color=as.factor(LevelWD)),method = "lm",fullrange = T) +
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
  ggtitle("Tree mortality as fc. of size") #+ 
  #scale_x_continuous(limits = c(3.4,4.1),breaks = seq(3.5,4,0.1)) + 
  #scale_y_continuous(limits = c(4.5,6.5),breaks = seq(4,7,1))
...
stl_NSC_WD <- ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
  ggtitle("Tree mortality as fc. of C starvation") #+ 
  #scale_x_continuous(limits = c(3.4,4.1),breaks = seq(3.5,4,0.1)) + 
  #scale_y_continuous(limits = c(4.5,6.5),breaks = seq(4,7,1))
...
stl_GR_WD <- ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
  ggtitle("Tree mortality as fc. of growth rate") #+ 
  #scale_x_continuous(limits = c(3.4,4.1),breaks = seq(3.5,4,0.1)) + 
  #scale_y_continuous(limits = c(4.5,6.5),breaks = seq(4,7,1)) 
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(stl_DBH_WD,stl_NSC_WD,stl_GR_WD, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_stl_wd.tiff", width = 9, height = 3, device='tiff', dpi=300)
```
...
# Mortality as a function of DBH
ea1sb1DBHgl_out_annual_tileMaxAgg <- ea1sb1DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),
          MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

ea1sb2DBHgl_out_annual_tileMaxAgg <- ea1sb2DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),DBH_mean=mean(DBH,na.rm=T), DBH_sd=sd(DBH,na.rm=T),MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

ea1sb3DBHgl_out_annual_tileMaxAgg <- ea1sb3DBHgl_out_annual_tile %>% dplyr::filter(year>=1500&year<=1801) %>% summarise(maxAge_mean=mean(MaxAge,na.rm=T), maxAge_sd=sd(MaxAge,na.rm=T),DBH_mean=mean(DBH,na.rm=T), DBH_sd=sd(DBH,na.rm=T),MaxDBH_MaxAge_mean=mean(MaxDBH_MaxAge,na.rm=T), MaxDBH_MaxAge_sd=sd(MaxDBH_MaxAge,na.rm=T))

long_DBH_WD <- ggplot() + 
  geom_point(data=ea1sb1DBHgl_out_annual_tileMaxAgg, aes(x=MaxDBH_MaxAge_mean, y=maxAge_mean, color='300 kgC m-3')) + 
  geom_point(data=ea1sb2DBHgl_out_annual_tileMaxAgg, aes(x=MaxDBH_MaxAge_mean, y=maxAge_mean, color='450 kgC m-3')) +
  geom_point(data=ea1sb3DBHgl_out_annual_tileMaxAgg, aes(x=MaxDBH_MaxAge_mean, y=maxAge_mean, color='600 kgC m-3')) +
  scale_color_manual("Levels of WD", breaks = c("300 kgC m-3", "450 kgC m-3", "600 kgC m-3"), values = c("#00AFBB", "#E7B800", "#FC4E07"))+
  labs(x = expression(paste("Growth rate (mm ",yr^-1,  ") ")), y = "Longevity") +  
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        axis.text = element_text(size = 10),axis.title = element_text(size = 11),
...
long_GR_WD <- ggplot() + 
  ...
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom",
        ...
        legend.text = element_text(size = 10),legend.title = element_text(size = 11),
        plot.title = element_text(size = 11)) + 
  labs(title= "Tree mortality as a fc. of C growth rate")
...
```{r, include=F, eval=T,fig.height=3.5,fig.width=10}
ggarrange(long_DBH_WD,long_NSC_WD,long_GR_WD, ncol = 3, nrow = 1, common.legend = T,legend="bottom")
ggsave("plot_long_wd.tiff", width = 9, height = 3, device='tiff', dpi=300)
```
...
### 1. Stand develop: Stand biomass vs. time
```{r, include=F, eval=T,fig.height=5,fig.width=10}
ggarrange(Bio_DBH_LUE,Bio_DBH_WD, ncol = 2, nrow = 1, common.legend = F,legend="bottom")
ggsave("Bio_DBH.tiff", width = 10, height = 5, device='tiff', dpi=300)
```

### 3. Carbon Turnover time vs. time
```{r, include=F, eval=T,fig.height=5,fig.width=10}
ggarrange(Tau_DBH_LUE,Tau_DBH_WD, ncol = 2, nrow = 1, common.legend = F,legend="bottom")
ggsave("Tau_DBH.tiff", width = 10, height = 5, device='tiff', dpi=300)
```
