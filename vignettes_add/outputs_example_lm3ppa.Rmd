...
setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_DBH$data[[1]]$output_hourly_tile,   "ea1sa1magl_out_hourly_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_tile,    "ea1sa1magl_out_daily_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_cohorts, "ea1sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_tile,   "ea1sa1magl_out_annual_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_cohorts,"ea1sa1magl_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_DBH$data[[1]]$output_hourly_tile,   "ea2sa1magl_out_hourly_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_tile,    "ea2sa1magl_out_daily_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_cohorts, "ea2sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_tile,   "ea2sa1magl_out_annual_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_cohorts,"ea2sa1magl_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_DBH$data[[1]]$output_hourly_tile,   "ea3sa1magl_out_hourly_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_tile,    "ea3sa1magl_out_daily_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_cohorts, "ea3sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_tile,   "ea3sa1magl_out_annual_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_cohorts,"ea3sa1magl_out_annual_cohorts.csv")

# p-model Mortality a) DBH
setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_DBH$data[[1]]$output_hourly_tile,   "ea1sa1mapm_out_hourly_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_tile,    "ea1sa1mapm_out_daily_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_cohorts, "ea1sa1mapm_out_daily_cohorts.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_tile,   "ea1sa1mapm_out_annual_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_cohorts,"ea1sa1mapm_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_DBH$data[[1]]$output_hourly_tile,   "ea2sa1mapm_out_hourly_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_tile,    "ea2sa1mapm_out_daily_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_cohorts, "ea2sa1mapm_out_daily_cohorts.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_tile,   "ea2sa1mapm_out_annual_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_cohorts,"ea2sa1mapm_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_DBH$data[[1]]$output_hourly_tile,   "ea3sa1mapm_out_hourly_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_tile,    "ea3sa1mapm_out_daily_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_daily_cohorts, "ea3sa1mapm_out_daily_cohorts.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_tile,   "ea3sa1mapm_out_annual_tile.csv")
write.csv(df_calib_DBH$data[[1]]$output_annual_cohorts,"ea3sa1mapm_out_annual_cohorts.csv")
...
setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_NSC$data[[1]]$output_hourly_tile,   "ea1sa1mbpm_out_hourly_tile.csv")
write.csv(df_calib_NSC$data[[1]]$output_daily_tile,    "ea1sa1mbpm_out_daily_tile.csv")
write.csv(df_calib_NSC$data[[1]]$output_daily_cohorts, "ea1sa1mbpm_out_daily_cohorts.csv")
write.csv(df_calib_NSC$data[[1]]$output_annual_tile,   "ea1sa1mbpm_out_annual_tile.csv")
write.csv(df_calib_NSC$data[[1]]$output_annual_cohorts,"ea1sa1mbpm_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_NSC$data[[1]]$output_hourly_tile,   "ea2sa1mbpm_out_hourly_tile.csv")
write.csv(df_calib_NSC$data[[1]]$output_daily_tile,    "ea2sa1mbpm_out_daily_tile.csv")
write.csv(df_calib_NSC$data[[1]]$output_daily_cohorts, "ea2sa1mbpm_out_daily_cohorts.csv")
write.csv(df_calib_NSC$data[[1]]$output_annual_tile,   "ea2sa1mbpm_out_annual_tile.csv")
write.csv(df_calib_NSC$data[[1]]$output_annual_cohorts,"ea2sa1mbpm_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_NSC$data[[1]]$output_hourly_tile,   "ea3sa1mbpm_out_hourly_tile.csv")
write.csv(df_calib_NSC$data[[1]]$output_daily_tile,    "ea3sa1mbpm_out_daily_tile.csv")
write.csv(df_calib_NSC$data[[1]]$output_daily_cohorts, "ea3sa1mbpm_out_daily_cohorts.csv")
write.csv(df_calib_NSC$data[[1]]$output_annual_tile,   "ea3sa1mbpm_out_annual_tile.csv")
write.csv(df_calib_NSC$data[[1]]$output_annual_cohorts,"ea3sa1mbpm_out_annual_cohorts.csv")
...
setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_GR$data[[1]]$output_hourly_tile,   "ea1sa1mcpm_out_hourly_tile.csv")
write.csv(df_calib_GR$data[[1]]$output_daily_tile,    "ea1sa1mcpm_out_daily_tile.csv")
write.csv(df_calib_GR$data[[1]]$output_daily_cohorts, "ea1sa1mcpm_out_daily_cohorts.csv")
write.csv(df_calib_GR$data[[1]]$output_annual_tile,   "ea1sa1mcpm_out_annual_tile.csv")
write.csv(df_calib_GR$data[[1]]$output_annual_cohorts,"ea1sa1mcpm_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_GR$data[[1]]$output_hourly_tile,   "ea2sa1mcpm_out_hourly_tile.csv")
write.csv(df_calib_GR$data[[1]]$output_daily_tile,    "ea2sa1mcpm_out_daily_tile.csv")
write.csv(df_calib_GR$data[[1]]$output_daily_cohorts, "ea2sa1mcpm_out_daily_cohorts.csv")
write.csv(df_calib_GR$data[[1]]$output_annual_tile,   "ea2sa1mcpm_out_annual_tile.csv")
write.csv(df_calib_GR$data[[1]]$output_annual_cohorts,"ea2sa1mcpm_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_GR$data[[1]]$output_hourly_tile,   "ea3sa1mcpm_out_hourly_tile.csv")
write.csv(df_calib_GR$data[[1]]$output_daily_tile,    "ea3sa1mcpm_out_daily_tile.csv")
write.csv(df_calib_GR$data[[1]]$output_daily_cohorts, "ea3sa1mcpm_out_daily_cohorts.csv")
write.csv(df_calib_GR$data[[1]]$output_annual_tile,   "ea3sa1mcpm_out_annual_tile.csv")
write.csv(df_calib_GR$data[[1]]$output_annual_cohorts,"ea3sa1mcpm_out_annual_cohorts.csv")

# gs-leuning Mortality d) Constant Self-thinning
setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_CST$data[[1]]$output_hourly_tile,   "ea1sa1mdgl_out_hourly_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_tile,    "ea1sa1mdgl_out_daily_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_cohorts, "ea1sa1mdgl_out_daily_cohorts.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_tile,   "ea1sa1mdgl_out_annual_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_cohorts,"ea1sa1mdgl_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_CST$data[[1]]$output_hourly_tile,   "ea2sa1mdgl_out_hourly_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_tile,    "ea2sa1mdgl_out_daily_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_cohorts, "ea2sa1mdgl_out_daily_cohorts.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_tile,   "ea2sa1mdgl_out_annual_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_cohorts,"ea2sa1mdgl_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_CST$data[[1]]$output_hourly_tile,   "ea3sa1mdgl_out_hourly_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_tile,    "ea3sa1mdgl_out_daily_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_cohorts, "ea3sa1mdgl_out_daily_cohorts.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_tile,   "ea3sa1mdgl_out_annual_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_cohorts,"ea3sa1mdgl_out_annual_cohorts.csv")

# p-model Mortality d) Constant Self-thinning
setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_CST$data[[1]]$output_hourly_tile,   "ea1sa1mdpm_out_hourly_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_tile,    "ea1sa1mdpm_out_daily_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_cohorts, "ea1sa1mdpm_out_daily_cohorts.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_tile,   "ea1sa1mdpm_out_annual_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_cohorts,"ea1sa1mdpm_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_CST$data[[1]]$output_hourly_tile,   "ea2sa1mdpm_out_hourly_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_tile,    "ea2sa1mdpm_out_daily_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_cohorts, "ea2sa1mdpm_out_daily_cohorts.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_tile,   "ea2sa1mdpm_out_annual_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_cohorts,"ea2sa1mdpm_out_annual_cohorts.csv")

setwd("/Users/lmarques/rsofun/outputs_lm3ppa")
write.csv(df_calib_CST$data[[1]]$output_hourly_tile,   "ea3sa1mdpm_out_hourly_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_tile,    "ea3sa1mdpm_out_daily_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_daily_cohorts, "ea3sa1mdpm_out_daily_cohorts.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_tile,   "ea3sa1mdpm_out_annual_tile.csv")
write.csv(df_calib_CST$data[[1]]$output_annual_cohorts,"ea3sa1mdpm_out_annual_cohorts.csv")
...
ggplot() + 
  ...
  labs(col = "Level of LUE", x = "Stand size", y = "Tree density") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") + 
...
ggplot() + 
  ...
  labs(col = "Level of LUE", x = "Ln(QMD)", y = "Ln(N)") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Function of C starvation") 
...
ggplot() + 
  ...
  labs(col = "Level of LUE", x = "Ln(QMD)", y = "Ln(N)") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Function of Constant Self-thinning gs-Leuning") + scale_x_continuous(limits = c(-2.4,-1))

ggplot() + 
  geom_point(data=subset(ea1sa1mdpm_out_annual_tile,year>=50), aes(x=log(QMD), y=log(Density12), color='Control')) + 
  geom_point(data=subset(ea2sa1mdpm_out_annual_tile,year>=50), aes(x=log(QMD), y=log(Density12), color='+15%')) +
  geom_point(data=subset(ea3sa1mdpm_out_annual_tile,year>=50), aes(x=log(QMD), y=log(Density12), color='+30%')) +
  scale_color_manual("Levels of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#00BA38", "#619CFF"))+
  labs(col = "Level of LUE", x = "Ln(QMD)", y = "Ln(N)") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Function of Constant Self-thinning p-model") 
...
# Mortality as a function of Self-thinning
ggplot() + 
  geom_line(data=ea1sa1mdgl_out_annual_tile, aes(x=year, y=Density12, color='Control')) + 
  geom_line(data=ea2sa1mdgl_out_annual_tile, aes(x=year, y=Density12, color='+15%')) +
  geom_line(data=ea3sa1mdgl_out_annual_tile, aes(x=year, y=Density12, color='+30%')) +
  scale_color_manual("Levels of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#00BA38", "#619CFF"))+
  labs(x = "Year", y = "Density12") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Function of Constant Self-thinning gs-Leuning") 

ggplot() + 
  geom_line(data=ea1sa1mdgl_out_annual_tile, aes(x=year, y=Density, color='Control')) + 
  geom_line(data=ea2sa1mdgl_out_annual_tile, aes(x=year, y=Density, color='+15%')) +
  geom_line(data=ea3sa1mdgl_out_annual_tile, aes(x=year, y=Density, color='+30%')) +
  scale_color_manual("Levels of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#00BA38", "#619CFF"))+
...
# Without spinup years (year>=100)
p <- ggplot() + 
  geom_point(data=subset(ea1sa1magl_out_annual_tile,year>=100), aes(x=log(QMD), y=log(Density12), color='Control')) + 
  geom_point(data=subset(ea2sa1magl_out_annual_tile,year>=100), aes(x=log(QMD), y=log(Density12), color='+15%')) +
  geom_point(data=subset(ea3sa1magl_out_annual_tile,year>=100), aes(x=log(QMD), y=log(Density12), color='+30%')) +
  scale_color_manual("Levels of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#00BA38", "#619CFF"))+
  labs(col = "Level of Light Use Efficiency", x = "Log Quadratic Mean Diameter", y = "Log Tree density") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Self-thinning relationships") 

p + transition_time(QMD) + shadow_mark(alpha = 0.3, size = 0.5) + enter_fly(y_loc = 0)
...
q <- ggplot() + 
  ...
  geom_line(data=ea3sa1magl_out_annual_tile, aes(x=year, y=plantC, color='+30%')) +
  scale_color_manual("Levels of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#00BA38", "#619CFF"))+
  labs(col = "Level of Light Use Efficiency", x = "Year", y = expression(paste("Biomass (Kg C ", m^-2, " ", yr^-1, ") "))) + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
...
# With spinup years
p <- ggplot() + 
  geom_point(data=ea1sa1magl_out_annual_tile, aes(x=log(QMD), y=log(Density12), color='Control')) + 
  geom_point(data=ea2sa1magl_out_annual_tile, aes(x=log(QMD), y=log(Density12), color='+15%')) +
  geom_point(data=ea3sa1magl_out_annual_tile, aes(x=log(QMD), y=log(Density12), color='+30%')) +
  scale_color_manual("Levels of LUE", breaks = c("Control", "+15%", "+30%"), values = c("#F8766D" ,"#00BA38", "#619CFF"))+
  labs(col = "Level of Light Use Efficiency", x = "Log Quadratic Mean Diameter", y = "Log Tree density") + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),legend.position = "bottom") +
  ggtitle("Mortality as a function of size") + scale_x_continuous(limits = c(-2.5,0))

p + transition_time(QMD) + shadow_mark(alpha = 0.3, size = 0.5) + enter_fly(y_loc = 0)

# Same but joining data
ea1sa1magl_out_annual_tile <- ea1sa1magl_out_annual_tile %>% mutate(LevelLUE = rep(1, dim(ea1sa1magl_out_annual_tile)[1])) 
ea2sa1magl_out_annual_tile <- ea2sa1magl_out_annual_tile %>% mutate(LevelLUE = rep(2, dim(ea2sa1magl_out_annual_tile)[1])) 
ea3sa1magl_out_annual_tile <- ea3sa1magl_out_annual_tile %>% mutate(LevelLUE = rep(3, dim(ea3sa1magl_out_annual_tile)[1])) 
...
q + transition_reveal(year) + transition_states(LevelLUE,transition_length = 2,state_length = 2)
