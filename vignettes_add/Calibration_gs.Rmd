...
params_tile <- tibble( #list
  ...
  tf_base      = 1,
  par_mort     = 1    # param_dbh=1 param_csv=-2 param_gr=10 CAI_MAX=2
...
```{r,include=FALSE, eval=TRUE}
#save(df_drivers, file = "~/data/rsofun/df_drivers_pmodel_dbh.RData")
save(df_drivers, file = "~/data/rsofun/df_drivers_gs_dbh.RData")
```
...
settings_calib_CST_gs <- list(
  ...
  par                 = list(phiRL = list(lower=0.5, upper=5, init=3.5),
                             LAI_light = list(lower=2, upper=5, init=3.5),
                             tf_base = list(lower=0.5, upper=1.5, init=1),
                             par_mort = list(lower=0.5, upper=2.5, init=2))
 )
...
save(settings_calib_DBH_gs, file = "~/data/rsofun/settings_calib_DBH_gs.RData")
...
save(settings_calib_NSC_gs, file = "~/data/rsofun/settings_calib_NSC_gs.RData")
...
save(settings_calib_GR_gs, file = "~/data/rsofun/settings_calib_GR_gs.RData")
...
```{r}
load("~/data/rsofun/settings_calib_DBH_gs.RData")
...
```{r}
load("~/data/rsofun/settings_calib_NSC_gs.RData")
...
```{r}
load("~/data/rsofun/settings_calib_GR_gs.RData")
...
settings_calib_GR_gs <- runread_lm3ppa_f(
     df_drivers,
     makecheck = TRUE,
     parallel = FALSE
     )

settings_calib_GR_gs$data[[1]]$output_annual_tile %>% 
  ggplot() +
  geom_line(aes(x = year, y = GPP)) +
  theme_classic()+labs(x = "Year", y = "GPP")
...
```{r}
# LUE
write.csv(df_calib_DBH_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea1sa1magl_out_hourly_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea1sa1magl_out_daily_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea1sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/ea1sa1magl_out_annual_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/ea1sa1magl_out_annual_cohorts.csv")

write.csv(df_calib_DBH_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea2sa1magl_out_hourly_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea2sa1magl_out_daily_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea2sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/ea2sa1magl_out_annual_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/ea2sa1magl_out_annual_cohorts.csv")

write.csv(df_calib_DBH_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea3sa1magl_out_hourly_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea3sa1magl_out_daily_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea3sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/ea3sa1magl_out_annual_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/ea3sa1magl_out_annual_cohorts.csv")

# PAR
write.csv(df_calib_DBH_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/eb2sa1magl_out_hourly_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/eb2sa1magl_out_daily_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/eb2sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/eb2sa1magl_out_annual_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/eb2sa1magl_out_annual_cohorts.csv")

write.csv(df_calib_DBH_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/eb3sa1magl_out_hourly_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/eb3sa1magl_out_daily_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/eb3sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/eb3sa1magl_out_annual_tile.csv")
write.csv(df_calib_DBH_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/eb3sa1magl_out_annual_cohorts.csv")
...
```{r}
# LUE
write.csv(df_calib_NSC_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea1sa1magl_out_hourly_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea1sa1magl_out_daily_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea1sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/ea1sa1magl_out_annual_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/ea1sa1magl_out_annual_cohorts.csv")

write.csv(df_calib_NSC_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea2sa1magl_out_hourly_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea2sa1magl_out_daily_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea2sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/ea2sa1magl_out_annual_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/ea2sa1magl_out_annual_cohorts.csv")

write.csv(df_calib_NSC_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea3sa1magl_out_hourly_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea3sa1magl_out_daily_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea3sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/ea3sa1magl_out_annual_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/ea3sa1magl_out_annual_cohorts.csv")

# PAR
write.csv(df_calib_NSC_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/eb2sa1magl_out_hourly_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/eb2sa1magl_out_daily_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/eb2sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/eb2sa1magl_out_annual_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/eb2sa1magl_out_annual_cohorts.csv")

write.csv(df_calib_NSC_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/eb3sa1magl_out_hourly_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/eb3sa1magl_out_daily_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/eb3sa1magl_out_daily_cohorts.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/eb3sa1magl_out_annual_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_annual_cohorts,"~/rsofun/outputs_lm3ppa/eb3sa1magl_out_annual_cohorts.csv")
