...
params_siml <- tibble( #list
      ...
      method_mortality      = "const_selfthing" # dbh or cstarvation or growthrate or const_selfthing
      )
```
...
model_size_dist <- df_output$data[[1]]$output_annual_cohorts %>%
  dplyr::filter(year>=1000) %>% # this is equivalent to tail(500), so the last 500 yrs of the simulation
  dplyr::filter(dbh>=12) %>%
  #mutate(size_bins = cut(dbh, breaks = 5)) %>% 
  mutate(size_bins = cut(dbh, breaks = c(12,32,52,72,92,112))) %>%
  group_by(size_bins,year) %>% summarise(nTrees=sum(density)) %>% ungroup() %>% group_by(size_bins) %>% summarise(nTrees=mean(nTrees))

ggplot(model_size_dist, aes(size_bins, nTrees)) + geom_col()



df_mod <- df_output$data[[1]]$output_annual_tile %>% 
    tail(params_siml$nyeartrend) %>% 
    dplyr::summarise(GPP = mean(GPP), LAI= quantile(LAI, probs = 0.95, na.rm=T), Biomass=mean(plantC))

  df_mod_sizedist <- df_output$data[[1]]$output_annual_cohorts %>%
    dplyr::filter(year>params_siml$spinupyears) %>% 
...
#LAE_nTrees <- LAE_nTrees %>% mutate(size_bins = cut(DBH_cm, breaks = quantile(DBH_cm, probs = seq(0, 1, 0.2),na.rm=F)))
LAE_nTrees <- LAE_nTrees %>% mutate(size_bins = cut(DBH_cm, breaks = quantile(DBH_cm, probs = seq(0, 1, 0.2),right = F)))

library(Hmisc)
LAE_nTrees$size_bins <- cut2(LAE_nTrees$DBH_cm, g = 5)
v1 <- sort(unique(LAE_nTrees$size_bins))
sizedist <- as.numeric(c(substr(v1, 2, 5),substr(v1[5], 7, 11)))
...
load("~/rsofun/input_data/ddf_obs.RData")
...
df_drivers$params_species[[1]]$LAI_light  <-  settings_calib_DBH_gs$par_opt$LAI_light      #["LAI_light"]
df_drivers$params_tile[[1]]$tf_base       <-  settings_calib_DBH_gs$par_opt$tf_base        #["tf_base"]
df_drivers$params_tile[[1]]$par_mort      <-  settings_calib_DBH_gs$par_opt$par_mort       #["par_mort"]
df_drivers$params_tile[[1]]$par_mort_under<-  settings_calib_DBH_gs$par_opt$par_mort_under #["par_mort_under"]
...
df_calib_DBH_gs$data[[1]]$output_annual_cohorts %>%
    ...
    dplyr::filter(dbh>=12) %>% mutate(size_bins = cut(dbh, breaks = c(12.1,17.8,28.0,40.8,54.0,105.4))) %>%
    group_by(size_bins,year) %>% summarise(nTrees=sum(density)) %>% ungroup() %>% group_by(size_bins) %>% summarise(nTrees=mean(nTrees))
...
```{r}
load("~/rsofun/input_data/df_drivers_NSC_gs.RData")
#load("~/rsofun/input_data/settings_calib_NSC_gs2nd.RData")
...
df_drivers$params_species[[1]]$LAI_light  <-  settings_calib_NSC_gs$par_opt$LAI_light      #["LAI_light"]
df_drivers$params_tile[[1]]$tf_base       <-  settings_calib_NSC_gs$par_opt$tf_base        #["tf_base"]
df_drivers$params_tile[[1]]$par_mort      <-  settings_calib_NSC_gs$par_opt$par_mort       #["par_mort"]
df_drivers$params_tile[[1]]$par_mort_under<-  settings_calib_NSC_gs$par_opt$par_mort_under #["par_mort_under"]
...
# rho_wood
write.csv(df_calib_NSC_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea1sb1NSCgl_out_hourly_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea1sb1NSCgl_out_daily_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea1sb1NSCgl_out_daily_cohorts.csv")
...
write.csv(df_calib_NSC_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea1sb2NSCgl_out_hourly_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea1sb2NSCgl_out_daily_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea1sb2NSCgl_out_daily_cohorts.csv")
...
write.csv(df_calib_NSC_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea1sb3NSCgl_out_hourly_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea1sb3NSCgl_out_daily_tile.csv")
write.csv(df_calib_NSC_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea1sb3NSCgl_out_daily_cohorts.csv")
...
# rho_wood
write.csv(df_calib_GR_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea1sb1GRgl_out_hourly_tile.csv")
write.csv(df_calib_GR_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea1sb1GRgl_out_daily_tile.csv")
write.csv(df_calib_GR_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea1sb1GRgl_out_daily_cohorts.csv")
...
write.csv(df_calib_GR_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea1sb2GRgl_out_hourly_tile.csv")
write.csv(df_calib_GR_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea1sb2GRgl_out_daily_tile.csv")
write.csv(df_calib_GR_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea1sb2GRgl_out_daily_cohorts.csv")
...
write.csv(df_calib_GR_gs$data[[1]]$output_hourly_tile,   "~/rsofun/outputs_lm3ppa/ea1sb3GRgl_out_hourly_tile.csv")
write.csv(df_calib_GR_gs$data[[1]]$output_daily_tile,    "~/rsofun/outputs_lm3ppa/ea1sb3GRgl_out_daily_tile.csv")
write.csv(df_calib_GR_gs$data[[1]]$output_daily_cohorts, "~/rsofun/outputs_lm3ppa/ea1sb3GRgl_out_daily_cohorts.csv")
