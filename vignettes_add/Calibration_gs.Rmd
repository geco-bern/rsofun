...
write.csv(df_output$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/preGRgl_output_annual_tile.csv")
write.csv(df_output$data[[1]]$output_annual_cohorts,   "~/rsofun/outputs_lm3ppa/preGRgl_output_annual_cohorts.csv")
...
```{r,include=TRUE, eval=TRUE,fig.width = 2.5, fig.height = 3}

preDBHgl_out_annual_tile <- read.csv("~/rsofun/outputs_lm3ppa/preDBHgl_output_annual_tile.csv")
preDBHgl_out_annual_cohorts <- read.csv("~/rsofun/outputs_lm3ppa/preDBHgl_output_annual_cohorts.csv")

df_mod <- preDBHgl_out_annual_tile %>% 
...
df_mod_sizedist <- preDBHgl_out_annual_cohorts %>%
...
preNSCgl_out_annual_tile <- read.csv("~/rsofun/outputs_lm3ppa/preNSCgl_output_annual_tile.csv")
preNSCgl_out_annual_cohorts <- read.csv("~/rsofun/outputs_lm3ppa/preNSCgl_output_annual_cohorts.csv")
...
preGRgl_out_annual_tile <- read.csv("~/rsofun/outputs_lm3ppa/preGRgl_output_annual_tile.csv")
preGRgl_out_annual_cohorts <- read.csv("~/rsofun/outputs_lm3ppa/preGRgl_output_annual_cohorts.csv")
...
#f_drivers$params_species[[1]]$rho_wood  <- 600 # 300, 450, 600
...
df_drivers$params_species[[1]]$phiRL      <-  settings_calib_GR_gs$par_opt$phiRL          #["phiRL"]
df_drivers$params_species[[1]]$LAI_light  <-  settings_calib_GR_gs$par_opt$LAI_light      #["LAI_light"]
df_drivers$params_tile[[1]]$tf_base       <-  settings_calib_GR_gs$par_opt$tf_base        #["tf_base"]
df_drivers$params_tile[[1]]$par_mort      <-  settings_calib_GR_gs$par_opt$par_mort       #["par_mort"]
df_drivers$params_tile[[1]]$par_mort_under<-  settings_calib_GR_gs$par_opt$par_mort_under #["par_mort_under"]
