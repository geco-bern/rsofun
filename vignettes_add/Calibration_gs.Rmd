...
params_siml <- tibble( #list
      spinup                = TRUE,
      spinupyears           = 700, 
      recycle               = 500,    # 9 or 11 changed to 1 when aggregating forcing into 1 year
      firstyeartrend        = 2009, 
      nyeartrend            = 500,    # 9 or 11 (longer transient years)
      outputhourly          = TRUE,
      outputdaily           = TRUE,
...
if (params_siml$method_photosynth == "gs_leuning"){
  ...
  forcing <- bind_rows(replicate(500, forcing, simplify = FALSE)) # Duplicate for the # of transient years
}
...
settings_calib_NSC_gs <- list(
  ...
  targetvars          = c("targets_obs"),
  timescale           = list(targets_obs = "y"),
  maxit               = 8, # (5 for gensa) (30 for optimr)
  sitenames           = "CH-Lae",
  metric              = "rmse",
  dir_results         = "./",
  name                = "ORG",
