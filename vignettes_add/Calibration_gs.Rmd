...
write.csv(df_output$data[[1]]$output_annual_tile,   "~/rsofun/outputs_lm3ppa/preGRgs_output_annual_tile.csv")
write.csv(df_output$data[[1]]$output_annual_cohorts,   "~/rsofun/outputs_lm3ppa/preGRgs_output_annual_cohorts.csv")
...
preDBHgl_out_annual_tile <- read.csv("~/rsofun/outputs_lm3ppa/preDBHgs_output_annual_tile.csv")
preDBHgl_out_annual_cohorts <- read.csv("~/rsofun/outputs_lm3ppa/preDBHgs_output_annual_cohorts.csv")
...
```{r,fig.width = 5, fig.height = 5}
load("~/rsofun/input_data/df_drivers_NSC_gs.RData")
load("~/rsofun/input_data/settings_calib_NSC_gs_euler.RData")
settings_calib_NSC_gs_euler$par_opt
#calib_param_nsc_gs <- read.csv("~/rsofun/params_calib_nsc_gs.csv")
#settings_calib_NSC_gs$par_opt <- calib_param_nsc_gs[1,]

df_drivers$params_species[[1]]$phiRL      <-  settings_calib_NSC_gs_euler$par_opt["phiRL"]
df_drivers$params_species[[1]]$LAI_light  <-  settings_calib_NSC_gs_euler$par_opt["LAI_light"]
df_drivers$params_tile[[1]]$tf_base       <-  settings_calib_NSC_gs_euler$par_opt["tf_base"]
df_drivers$params_tile[[1]]$par_mort      <-  settings_calib_NSC_gs_euler$par_opt["par_mort"]
df_drivers$params_tile[[1]]$par_mort_under<-  settings_calib_NSC_gs_euler$par_opt["par_mort_under"]
...
```{r,fig.width = 5, fig.height = 5}
load("~/rsofun/input_data/df_drivers_GR_gs.RData")
load("~/rsofun/input_data/settings_calib_GR_gs_euler.RData")
settings_calib_GR_gs$par_opt
