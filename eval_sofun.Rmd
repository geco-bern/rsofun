...
load("siteinfo.Rdata")
plot_map_siteoverview( siteinfo$light, 1/epop ) # , plotfiln="fig/map_sites.pdf"
...
nothing <- plot_by_doy_allzones( out_eval$data$meandoydf_byclim_stats, makepdf=TRUE )
```
...
eval_response_neuralnet( out_eval$data$ddf, makepdf=FALSE )
```
