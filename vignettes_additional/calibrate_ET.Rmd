...
# from calibration at US-Ha1, using RMSE:
a <- 0.1
b <- 3.841307
m <- 1.368163

# from calibration at US-Ha1, using chi-squared:
a <- 0.3035047    
b <- 1.0075488    
m <- 0.0100000 
...
```{r message=FALSE}
path_siteinfo <- "~/rsofun/siteinfo_pet_fluxnet2015.csv"
...
settings_sims <- list(
  ...
  dir_sofun       = "~/sofun/",
  path_output     = "~/sofun_outputs/output_pet_fluxnet2015_sofun/",
  path_output_nc  = "~/sofun_outputs/output_nc_pet_fluxnet2015_sofun/",
  path_input      = "~/sofun_inputs/input_pet_fluxnet2015_sofun/",
  grid            = NA,
...
settings_calib <- list(
  name             = "calib_et",
  par              = list( vpdstress_par_a = list( lower=0.1,  upper=2.0,  init=1.0 ),
                           vpdstress_par_b = list( lower=0.01, upper=20.0, init=0.1 ),
                           vpdstress_par_m = list( lower=0.01, upper=20.0, init=0.2 ) ),
  method           = "gensa",
...
### Prepare inputs
```{r, eval=FALSE, message=FALSE, warning=TRUE, results="hide"}
