...
<!-- For site-scale simulations conducted at FLUXNET 2015 Tier 1 sites, the meta information is provided along with the package `rsofun`. Let's look at this data as an example and save it in a CSV file, corresponding to the information specified above (under `settings_sims_sitescale$siteinfo`). -->
<!-- ```{r} -->
<!-- print( metainfo_Tier1_sites_kgclimate_fluxnet2015 ) -->
<!-- write_csv( metainfo_Tier1_sites_kgclimate_fluxnet2015, path = settings_sims_sitescale$siteinfo ) -->
<!-- ``` -->

```{r}
settings_sims_sitescale <- list(
  siteinfo   = path( rootdir, "/inst/extdata/siteinfo_fluxnet2015_sofun+whc.csv"),
  ensemble        = TRUE,
  setup           = "site",
  name            = "fluxnet2015",
  dir_sofun       = "~/sofun/trunk/",
