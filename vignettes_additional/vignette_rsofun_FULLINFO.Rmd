...
# lines( 1:100, gpp_temp_test_for, col = "red" )
# legend( "topright", c( paste("Fortran:", time_for, "s"), paste("R:", time_R, "s")), lty = 1, col = c("black", "red"), bty = "n")
```
...
settings_sims_sitescale <- list(
  path_siteinfo   = path( rootdir, "/inst/extdata/siteinfo_fluxnet2015_sofun+whc.csv"),
  ensemble        = TRUE,
  setup           = "site",
  name            = "fluxnet2015",
  dir_sofun       = "~/sofun/trunk/",
  path_output     = "~/sofun/output_fluxnet2015_sofun/",
  path_output_nc  = "~/sofun/output_nc_fluxnet2015_sofun/",
  path_input      = "~/sofun/input_fluxnet2015_sofun/",
  grid            = NA,
  implementation  = "fortran",
  in_ppfd         = TRUE,
  recycle         = 1,
...
<!-- ```{r, eval=FALSE, message=FALSE, warning=FALSE} -->
<!-- params_opt <- readr::read_csv( paste0("params_opt_calib_RED.csv") ) # as an example -->
