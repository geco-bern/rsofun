---
title: "LM3PPA model structure"
author: "Koen Hufkens"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{LM3PPA model structure}
...
This is a brief overview of some of the key components of the LM3PPA model structure. In particular it lays out some of the cohort based logic in calculating key fluxes and pools.
...
![](https://raw.githubusercontent.com/bluegreen-labs/rsofun/master/docs/canopy_diagram.png)
