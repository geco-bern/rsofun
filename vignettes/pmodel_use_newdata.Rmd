...
# run the model for these parameters
output <- rsofun::runread_pmodel_f(
  mutate(rsofun::p_model_drivers_formatPhydro,
         params_siml = params_siml |> mutate(use_gs = FALSE) |> list()),
  par = params_modl
)
```
...
output <- rsofun::runread_pmodel_f(
  mutate(rsofun::p_model_drivers_formatPhydro,
         params_siml = params_siml |> mutate(use_gs = TRUE) |> list()),
  par = params_modl
)
```
...
output <- rsofun::runread_pmodel_f(
  mutate(rsofun::p_model_drivers_formatPhydro,
         params_siml = params_siml |> mutate(use_gs = TRUE, use_pml = TRUE, use_phydro + FALSE) |> list()),
  par = params_modl
)
```
