...
Forcing data of `rsofun` adheres to a fixed format as described [here](https://computationales.github.io/rsofun/reference/p_model_drivers.html). Any data
in this format will be valid `rsofun` input data. However to facilitate the
formatting of these datasets you may use the internal lab tool [`ingestr`](https://github.com/computationales/ingestr). This
