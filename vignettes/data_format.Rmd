...
BiomeE follows the same data structure as P-model overall, but with some specific parameters and forcing data.
Details about thees can be obtained in the documentation: `?run_biomee_f_bysite`.

Here is an example of forcing data for BiomeE:
```{r}
# detailed look at the forcing data
