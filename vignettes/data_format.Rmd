...
- P-model (daily timeseries): `?run_pmodel_f_bysite`
- P-model (onestep acclimation): `?run_pmodel_onestep_f_bysite`
...
rsofun::pmodel_drivers$forcing[[1]]
```
...
For detailed information about the content of `data`, see `?runread_pmodel_f`.
