...
settings_calib_DBH <- list(
  ...
  name                = "ORG",
  par                 = list(kphio = list(lower=0.02, upper=0.1, init=0.05),
                             phiRL = list(lower=0.1, upper=12, init=3.5),
                             LAI_light = list(lower=0.1, upper=12, init=3.5),
                             tf_base = list(lower=0.01, upper=6, init=1),
...
df_drivers$params_species[[1]]$LAI_light  <- settings_calib_DBH$par_opt["LAI_light"]*1.30
