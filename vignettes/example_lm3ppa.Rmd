...
settings_calib_NSC <- list(
  ...
  targetvars          = c("targets_obs"),
  timescale           = list(targets_obs = "y"),
  maxit               = 20, # (5 for gensa) (30 for optimr)
  sitenames           = "CH-Lae",
  metric              = "rmse",
  dir_results         = "./",
  name                = "ORG",
...
save(settings_calib_DBH, file = "~/data/forcing/settings_calib_DBH.RData")
...
```{r}
########## Mortality as tree size ########## 
df_drivers$params_species[[1]]$phiRL  <-     2#settings_calib_DBH_gs$par_opt["phiRL"]
df_drivers$params_species[[1]]$LAI_light  <- 0.1#settings_calib_DBH_gs$par_opt["LAI_light"]
df_drivers$params_tile[[1]]$tf_base  <-      10#settings_calib_DBH_gs$par_opt["tf_base"]
df_drivers$params_tile[[1]]$par_mort <-      2#settings_calib_DBH_gs$par_opt["par_mort"]
