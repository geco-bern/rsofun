...
settings_calib_CST <- list(
  ...
  targetvars          = c("GPP","LAI","NTrees"),
  timescale           = list(GPP = "y", LAI = "y", NTrees = "y"),
...
settings_calib_DBH <- list(
  method              = "gensa", # gensa, optimr, BayesianTools, linscale
  targetvars          = c("GPP","AGB","LAI","NTrees"),
  timescale           = list(GPP = "y", LAI = "y", NTrees = "y"),
  maxit               = 5, # (5 for gensa) (30 for optimr)
  sitenames           = "CH-Lae",
  metric              = "rmse",
...
settings_calib <- calib_sofun(
  ...
  ddf_obs = c(mean_annual_gpp, max_annual_lai, nTreesFagus),
  settings = settings_calib_CST
  )

  ddf_obs = list(GPP = mean_annual_gpp, LAI = max_annual_lai, NTrees= nTreesFagus),
