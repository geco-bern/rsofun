...
par_calib_join <- calib_sofun(
  drivers = rbind(p_model_oldformat_drivers,
                  p_model_oldformat_drivers_vcmax25), 
  obs = rbind(p_model_oldformat_validation,
...
The cost functions provided in the package tell apart fluxes and leaf traits by the presence of a `"date"` column in the nested validation data frames `p_model_oldformat_validation` and `p_model_oldformat_validation_vcmax25`.
