...
saveRDS(pars_calib_likelihood, 
        here::here("vignettes", "files/new_cost_function.Rmd__pars_calib_likelihood.RDS"), 
        compress = "xz")
```
```{r include = FALSE}
# fake output since calibration isn't run
pars_calib_likelihood <- readRDS(here::here("vignettes","files/new_cost_function.Rmd__pars_calib_likelihood.RDS"))
```
```{r}
