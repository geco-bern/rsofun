...
There are equivalent cost functions available for the LM3PPA model, via`create_cost_*` functions. Check out the reference pages for more details on how to use them.
