...
function(par, obs, drivers){
  ...
  # Set values for calibrated and non-calibrated model parameters
  params_modl <- list(
    kphio = 0.05,
    soilm_par_a = par[1],
    soilm_par_b = par[2],
