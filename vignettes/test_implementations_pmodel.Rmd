...
nothing <- update_params( params_opt, "/alphadata01/bstocker/sofun/trunk/" )

pmodel_fortran <- purrr::map( as.list( seq( 0, 35, length.out = 100 ) ), 
  ~pmodel( temp = ., vpd = vpd, co2 = co2, ppfd = ppfd, fapar = fapar, elv = elv, implementation = "fortran", sofundir = "/alphadata01/bstocker/sofun/trunk/" ) )
```
