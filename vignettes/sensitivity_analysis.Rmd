...
settings_calib <- list(
  ...
  par = list(
    ...
    soilm_thetastar = list(
      lower = 0.01 * rsofun::p_model_oldformat_drivers$site_info[[1]]$whc,
      upper = 1.0  * rsofun::p_model_oldformat_drivers$site_info[[1]]$whc,
      init  = 0.6  * rsofun::p_model_oldformat_drivers$site_info[[1]]$whc
    ),
