...
# saveRDS(par_calib, here::here("analysis/paper_results_files/par_calib.rds"))
par_calib <- readRDS(here::here("analysis/paper_results_files/par_calib.rds"))
```
...
# TODO: get rid of this and always fully run the vignettes
# fake output since calibration isn't run
# saveRDS(pmodel_runs, file = here::here("analysis/paper_results_files/pmodel_runs.rds"))
pmodel_runs <- readRDS(here::here("analysis/paper_results_files/pmodel_runs.rds"))
```
