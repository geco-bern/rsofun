...
We can visually inspect the convergence of the MCMC below, with trace and density plots of all calibrated parameters. Both the quantum yield efficiency
and the GPP error term converged quite quickly, with very 
```{r eval = evaluate}
plot(par_calib$mod)
```
