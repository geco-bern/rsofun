...
GPP (in grey), accompanied by the predictive credible interval for modeled GPP 
(shaded in blue, very narrow) and the predictive credible interval for a new GPP 
observation (shaded in grey). We can see that the model uncertainty in quite 
small, in comparison to the data uncertainty.
