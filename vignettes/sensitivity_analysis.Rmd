...
ll_pmodel <- function(
  ...
  rsofun::cost_likelihood_pmodel(        # reuse likelihood cost function
    ...
    drivers = rsofun::p_model_drivers_format2024_08 |> rowwise() |> mutate(forcing = list(mutate(forcing, vwind=2.0))) |> ungroup(), #TODO rsofun::p_model_drivers is NOT YET UPDATED FOR PHYDRO (a newformat, b add phydro_ parameters)
    targets = "gpp"
  )
}
