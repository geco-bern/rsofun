...
```{r, "load", echo = FALSE}
load(paste0( rootdir, "/tmpdir/settings_sims_sitescale.Rdata" ) )
```
...
```{r message=FALSE}
load( paste0( rootdir, "/tmpdir/settings_sims_sitescale.Rdata" ) )
load( paste0( rootdir, "/tmpdir/settings_input_sitescale.Rdata" ) )
load( paste0( rootdir, "/tmpdir/setup_sofun_sitescale.Rdata" ) )
```

Define common model evaluation settings as a list.
```{r, eval=FALSE, message=FALSE}
mylist <- readr::read_csv("my_external_stuff/myselect_fluxnet2015.csv") %>% dplyr::filter( use==1 ) %>% dplyr::select( -use ) %>% unlist()
settings_eval <- list(
...
if (!file.exists("tmpdir/mod_FULL.Rdata")){
  ...
  ## update files containing parameter values read by model
  params_opt <- readr::read_csv( "tmpdir/params_opt_FULL.csv" )
  nothing <- update_params( params_opt, settings_sims_sitescale$dir_sofun )
...
if (!file.exists("tmpdir/mod_RED_FPARitp.Rdata")){
  ...
  ## update files containing parameter values read by model
  params_opt <- readr::read_csv( "tmpdir/params_opt_RED_FPARitp.csv" )
  nothing <- update_params( params_opt, settings_sims_sitescale$dir_sofun )
...
if (!file.exists("tmpdir/mod_RED_EVI.Rdata")){
  ...
  ## update files containing parameter values read by model
  params_opt <- readr::read_csv( "tmpdir/params_opt_RED_EVI.csv" )
  nothing <- update_params( params_opt, settings_sims_sitescale$dir_sofun )
...
if (!file.exists("tmpdir/mod_RED_DT.Rdata")){
  ...
  ## update files containing parameter values read by model
  params_opt <- readr::read_csv( "tmpdir/params_opt_RED_DT.csv" )
  nothing <- update_params( params_opt, settings_sims_sitescale$dir_sofun )
...
if (!file.exists("tmpdir/mod_RED_Ty.Rdata")){
  ...
  ## update files containing parameter values read by model
  params_opt <- readr::read_csv( "tmpdir/params_opt_RED_Ty.csv" )
  nothing <- update_params( params_opt, settings_sims_sitescale$dir_sofun )
