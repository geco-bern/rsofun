...
params_opt <- read_csv( paste0("params_opt_RED.csv") )
...
if (!exists("obs_eval_NT")) load("obs_eval_NT.Rdata")
...
## update files containing parameter values read by model
params_opt <- read_csv( paste0("params_opt_FULL.csv") )
nothing <- update_params( params_opt, settings = settings_sims_sitescale )
...
## get sites for which no model output is available and overwrite settings_eval$sitenames
if (!exists("mod_FULL")) load("mod_FULL.Rdata")
...
if (!exists("out_eval_FULL")) load("out_eval_FULL.Rdata")
...
if (!exists("out_eval_NULL")) load("out_eval_NULL.Rdata")
...
if (!exists("out_eval_NULLpft")) load("out_eval_NULLpft.Rdata")
...
## update files containing parameter values read by model
params_opt <- read_csv( paste0("params_opt_RED_FPARitp.csv") )
nothing <- update_params( params_opt, settings = settings_sims_sitescale )
...
## get sites for which no model output is available and overwrite settings_eval$sitenames
if (!exists("mod_RED_FPARitp")) load("mod_RED_FPARitp.Rdata")
...
if (!exists("out_eval_RED_FPARitp")) load("out_eval_RED_FPARitp.Rdata")
