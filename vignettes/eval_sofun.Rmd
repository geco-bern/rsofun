...
obs_eval_RED <- get_obs_eval( settings_eval = settings_eval, settings_input = settings_input_sitescale, settings_sims = settings_sims_sitescale, overwrite = TRUE )
save( obs_eval_RED, file = "obs_eval_RED.Rdata")

## evaluate RED simulations
if (!exists("obs_eval_RED")) load("obs_eval_RED.Rdata")
out_eval_RED <- eval_sofun( mod_RED, settings_eval, settings_sims_sitescale, siteinfo, obs_eval = obs_eval_RED, doplot=FALSE, overwrite = TRUE )
save( out_eval_RED, file = "out_eval_RED.Rdata" )

## Plot mod-vs-obs for daily values
modobs_ddf <- plot_modobs_daily( out_eval_RED$data$ddf, subtitle = "RED, FPARspl, NT", dir = "./fig", makepdf = TRUE )
```
