...
plot_eval(df_plot, return_gg1 = TRUE)
plot_eval(df_plot, return_gg2 = TRUE)
```
...
```{r}
# xxx test
p_model_drivers$site_info[[1]]$whc <- 100
...
<!-- ```{r} -->
<!-- phydro_model_drivers <- rsofun::p_model_drivers_formatPhydro |>  -->
<!--   rename(forcing_acclim = forcing_3hrmax) -->

<!--   # mutate(forcing = purrr::map(forcing, ~mutate(., vwind = NA))) -->

<!-- phydro_model_drivers$forcing[[1]]$vwind <- NA  -->
<!-- phydro_model_drivers$forcing_acclim[[1]]$vwind <- NA  -->
<!-- ``` -->
...
<!-- output <- rsofun::runread_pmodel_f( -->
<!--   mutate( -->
<!--     phydro_model_drivers,  -->
<!--     params_siml = params_siml |>  -->
<!--       mutate(use_gs = TRUE, use_phydro = TRUE) |>  -->
<!--       list() -->
<!--     ), -->
<!--   par = params_modl -->
<!-- ) -->
...
<!--   select(date, mod = gpp) |>  -->
<!--   left_join( -->
<!--     rsofun::p_model_validation_formatPhydro$data[[1]] |>  -->
<!--       select(date, obs = gpp), -->
<!--     by = join_by(date) -->
<!--   ) |>  -->
<!--   as_tibble() -->
