...
params_modl <- list(
  ...
  tau_acclim         = 20.0,
  kc_jmax            = 0.41,
  coldacclim_par_a   = 0.0, # all zero disables cold acclimation
...
tidyr::as_tibble(out_rpmodel) |>
  ...
  dplyr::mutate(
    gs   = gs / 1 / (300 / 10^6), # divide by fapar (-) and by ppfd (mol/m2/s)
