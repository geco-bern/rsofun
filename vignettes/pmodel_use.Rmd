...
out_rpmodel <- rpmodel( 
  ...
  ppfd           = 300,          # mol/m2/d,
  patm           = 101325,       # Pa
  kphio          = 0.04998,      # quantum yield efficiency as calibrated for setup ORG by Stocker et al. 2020 GMD,
...
# out_rpmodel
tidyr::as_tibble(out_rpmodel) |> dplyr::select(vcmax, jmax, vcmax25, jmax25, gs, chi, iwue, rd, everything())
```
