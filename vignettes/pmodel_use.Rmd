...
ggplot() + 
  geom_line(data = p_model_drivers$forcing[[1]], aes(date, netrad)) +
  geom_line(data = output$data[[1]], aes(date, netrad), color = "red")
```
