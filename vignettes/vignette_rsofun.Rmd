...
settings_calib <- list(
  ...
  metric           = "rmse",
  dir_results      = "/Users/benjaminstocker/alphadata01/bstocker/rsofun/calib_results" # use absolute path!
 )
```
...
settings_eval <- list(
  ...
  path_gepisat_d     = "",
  dir_figs           = "~/alphadata01/bstocker/rsofun/fig/"
  )
```
...
# modobs_mdf <- out_eval$plot$modobs_monthly( dir = "./fig", makepdf = TRUE )
# modobs_spatial <- out_eval$plot$modobs_spatial( dir = "./fig", makepdf = TRUE )
# out_eval$plot$modobs_spatial_annual( dir = "./fig", makepdf = TRUE )
```
