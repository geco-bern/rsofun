...
In the example given here, we use a site meta information file provided along with the `rsofun` package. It's located at the path `/rsofun/inst/extdata/siteinfo_fluxnet2015_sofun+whc.csv`. For demonstration, 

The SOFUN directory will be cloned using `git` locally and placed in `"~/sofun/trunk/"`. This information, along with more, is specified as a list as shown below.
