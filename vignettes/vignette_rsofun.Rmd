...
params_opt <- readr::read_csv( paste0( path.package("rsofun"), "/tmpdir/params_opt_kphio_soilm_global.csv" ) ) # as an example
...
settings_calib <- list(
  ...
  metric           = "rmse",
  dir_results      = paste0( path.package("rsofun"), "/tmpdir" )
 )
```
