...
Compare output files written by SOFUN in branch lm3ppa_BiomeE_test_rsofun with RSOFUN implementation in R. If differences exist, find cause based on print statements.
