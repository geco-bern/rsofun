...
plot_dfs <- lapply(names(sofun_out_hourly_tile),function(nm)data.frame(col1 = sofun_out_hourly_tile[,1],col2 = sofun_out_hourly_tile[,nm], col3 = rsofun_out_hourly_tile[,nm]))
...
plot_dfs <- lapply(names(sofun_out_daily_tile),function(nm)data.frame(col1 = sofun_out_daily_tile[,1],col2 = sofun_out_daily_tile[,nm], col3 = rsofun_out_daily_tile[,nm]))

ggplot() + 
  geom_line(data=sofun_out_daily_tile, aes(x=year, y=totWs), color='blue', size = 2) + 
  geom_line(data=rsofun_out_daily_tile, aes(x=year, y=totWs), color='red')
...
plot_dfs <- lapply(names(sofun_out_daily_cohorts),function(nm)data.frame(col1 = sofun_out_daily_cohorts[,1],col2 = sofun_out_daily_cohorts[,nm], col3 = rsofun_out_daily_cohorts[,nm]))
...
plot_dfs <- lapply(names(sofun_out_annual_tile),function(nm)data.frame(col1 = sofun_out_annual_tile[,1],col2 = sofun_out_annual_tile[,nm], col3 = rsofun_out_annual_tile[,nm]))

for (idx in seq_along(plot_dfs))
  print(ggplot()+geom_line(data = plot_dfs[[idx]], aes(x=col1, y=col2),color="blue") +
      geom_line(data = plot_dfs[[idx]], aes(x=col1, y=col3),color="red")+
...
plot_dfs <- lapply(names(sofun_out_annual_cohorts),function(nm)data.frame(col1 = sofun_out_annual_cohorts[,1],col2 = sofun_out_annual_cohorts[,nm], col3 = rsofun_out_annual_cohorts[,nm]))
