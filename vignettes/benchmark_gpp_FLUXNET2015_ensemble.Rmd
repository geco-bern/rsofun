...
Load drivers data frame (created by vignette `prepare_inputs_FLUXNET2015_ensemble.Rmd`).
```{r}
...
params_modl <- list(
	...
	soilm_par_a     = 0,
	soilm_par_b     = 0.73300,
	vpdstress_par_a = 9999,  # irrelevant
	vpdstress_par_b = 9999,  # irrelevant
	vpdstress_par_m = 9999   # irrelevant
	)

# ## BRC
# params_modl <- list(
# 	kphio           = 0.08179,
# 	soilm_par_a     = 9999,  # irrelevant
# 	soilm_par_b     = 9999,  # irrelevant
# 	vpdstress_par_a = 9999,  # irrelevant
# 	vpdstress_par_b = 9999,  # irrelevant
# 	vpdstress_par_m = 9999   # irrelevant
# 	)
...
gg$gg +
  labs(title = "8-daily: Modelled vs. observed GPP", 
