...
pars <- list(
  par = c(phiRL     = 1.86467244630407,
          LAI_light = 6.67994629750767,
          tf_base   = 0.610053130958959,
          par_mort  = 0.0247470739328088
)) # TODO: update these for better fit since using thetaHT = thetaBM - 2, and thetaCA = thetaBM - 1
```
