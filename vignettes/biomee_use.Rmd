...
```{r echo = FALSE}
biomee_gs_leuning_output_annual_tile <- biomee_gs_leuning_output$data[[1]]$output_annual_tile
biomee_gs_leuning_output_annual_cohorts <- biomee_gs_leuning_output$data[[1]]$output_annual_cohorts
```
...
```{r echo = FALSE}
biomee_p_model_output_annual_tile <- biomee_p_model_output$data[[1]]$output_annual_tile
biomee_p_model_output_annual_cohorts <- biomee_p_model_output$data[[1]]$output_annual_cohorts
```
...
ggplot() +
  geom_line(data = biomee_p_model_output$data[[1]]$output_annual_tile,
            aes(x = year, y = GPP)) +
