...
test_that("Regression tests run_biomee_f_bysite()", {
  ...
  expect_equal(tibble(mod_BiomeE_Pmodel$data$output_annual_cohorts)|>filter(year==  1)|>arrange(-DBH),                 ref_BiomeE_Pmodel_oac_yr1)
  expect_equal(tibble(mod_BiomeE_Pmodel$data$output_annual_cohorts)|>filter(year==  2)|>arrange(-DBH),                 ref_BiomeE_Pmodel_oac_yr2)
  expect_equal(tibble(mod_BiomeE_Pmodel$data$output_annual_cohorts)|>filter(year==251)|>arrange(-DBH),                 ref_BiomeE_Pmodel_oac_yr251)
  ...
  expect_equal(tibble(mod_BiomeE_gsLeun$data$output_annual_cohorts)|>filter(year==  1)|>arrange(-DBH),                 ref_BiomeE_gsLeun_oac_yr1)
