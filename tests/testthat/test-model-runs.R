...
test_that("Regression tests run_biomee_f_bysite()", {
  ...
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_Pmodel$data$output_daily_tile )|>filter(year==  1, doy %in% c(1, 2, 180, 364, 365)),  ref_BiomeE_Pmodel_odt_yr1)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_Pmodel$data$output_daily_tile )|>filter(year==251, doy %in% c(1, 2, 180, 364, 365)),  ref_BiomeE_Pmodel_odt_yr251)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_Pmodel$data$output_annual_tile)|>filter(           year %in% c(1, 2, 8, 9, 16, 251)), ref_BiomeE_Pmodel_oat)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_Pmodel$data$output_annual_cohorts)|>filter(year==  1)|>arrange(-DBH),                 ref_BiomeE_Pmodel_oac_yr1)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_Pmodel$data$output_annual_cohorts)|>filter(year==  2)|>arrange(-DBH),                 ref_BiomeE_Pmodel_oac_yr2)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_Pmodel$data$output_annual_cohorts)|>filter(year==251)|>arrange(-DBH),                 ref_BiomeE_Pmodel_oac_yr251)
  
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_gsLeun$data$output_daily_tile )|>filter(year==  1, doy %in% c(1, 2, 180, 364, 365)),  ref_BiomeE_gsLeun_odt_yr1)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_gsLeun$data$output_daily_tile )|>filter(year==251, doy %in% c(1, 2, 180, 364, 365)),  ref_BiomeE_gsLeun_odt_yr251)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_gsLeun$data$output_annual_tile)|>filter(           year %in% c(1, 2, 8, 9, 16, 251)), ref_BiomeE_gsLeun_oat)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_gsLeun$data$output_annual_cohorts)|>filter(year==  1)|>arrange(-DBH),                 ref_BiomeE_gsLeun_oac_yr1)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_gsLeun$data$output_annual_cohorts)|>filter(year==  2)|>arrange(-DBH),                 ref_BiomeE_gsLeun_oac_yr2)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_gsLeun$data$output_annual_cohorts)|>filter(year==251)|>arrange(-DBH),                 ref_BiomeE_gsLeun_oac_yr251)
  ...
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$aggregated|>filter(                           year %in% c(1, 2, 8, 9, 16, 251))),   ref_BiomeE_PLULUC_aggregated)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$primary$output_daily_tile|>filter(year==  1, doy %in% c(1, 2, 180, 364, 365))),     ref_BiomeE_PLULUC_primary_odt_yr1)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$primary$output_daily_tile|>filter(year==251, doy %in% c(1, 2, 180, 364, 365))),     ref_BiomeE_PLULUC_primary_odt_yr251)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$primary$output_annual_tile|>filter(           year %in% c(1, 2, 8, 9, 16, 251))),   ref_BiomeE_PLULUC_primary_oat)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$primary$output_annual_cohorts|>filter(year==  1)),                                  ref_BiomeE_PLULUC_primary_oac_yr1)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$primary$output_annual_cohorts|>filter(year==  2)),                                  ref_BiomeE_PLULUC_primary_oac_yr2)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$primary$output_annual_cohorts|>filter(year==251)),                                  ref_BiomeE_PLULUC_primary_oac_yr251)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$secondary$output_daily_tile|>filter(year==  1, doy %in% c(1, 2, 180, 364, 365))),     ref_BiomeE_PLULUC_secondary_odt_yr1)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$secondary$output_daily_tile|>filter(year==251, doy %in% c(1, 2, 180, 364, 365))),     ref_BiomeE_PLULUC_secondary_odt_yr251)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$secondary$output_annual_tile|>filter(           year %in% c(1, 2, 8, 9, 16, 251))),   ref_BiomeE_PLULUC_secondary_oat)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$secondary$output_annual_cohorts|>filter(year==  1)),                                  ref_BiomeE_PLULUC_secondary_oac_yr1)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$secondary$output_annual_cohorts|>filter(year==  2)),                                  ref_BiomeE_PLULUC_secondary_oac_yr2)
  expect_equal(tolerance = 1e-3, tibble(mod_BiomeE_PLULUC$secondary$output_annual_cohorts|>filter(year==251)),                                  ref_BiomeE_PLULUC_secondary_oac_yr251)
})
